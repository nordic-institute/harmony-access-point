...
public class JMSPluginReceivingListenerTest {
    ...
    @Test
    public void receiveMessage(@Injectable MapMessage map, @Mocked DomibusLoggerImpl LOG) {
    ...
    @Test
    public void authenticate(@Injectable MapMessage map, @Mocked DomibusLoggerImpl LOG) throws JMSException {
    ...
    public void authenticateWithMissingUsername(@Injectable MapMessage map, @Mocked DomibusLoggerImpl LOG) throws JMSException {
        new Expectations() {{
            map.getStringProperty(JMSMessageConstants.USERNAME);
            result = null;
        }};
    ...
    @Test(expected = DefaultJmsPluginException.class)
    public void authenticateWithMissingPassword(@Injectable MapMessage map, @Mocked DomibusLoggerImpl LOG) throws JMSException {
        String username = "cosmin";
