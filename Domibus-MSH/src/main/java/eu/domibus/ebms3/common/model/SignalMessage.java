...
public class SignalMessage extends AbstractBaseEntity {
    ...
    @OneToOne(mappedBy = "signalMessage", cascade = CascadeType.REMOVE, fetch = FetchType.LAZY)
    @XmlTransient
     ...
     *
     * @see eu.domibus.ebms3.common.model.Error
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link eu.domibus.ebms3.common.model.Error }
     *
