...
public class MessagingServiceImpl implements MessagingService {
    ...
    @Override
    @Transactional
    public void persistReceivedMessage(Messaging messaging, Messaging responseMessaging, BackendFilter matchingBackendFilter, UserMessage userMessage, String backendName, Party to, NotificationStatus notificationStatus) throws EbMS3Exception {
