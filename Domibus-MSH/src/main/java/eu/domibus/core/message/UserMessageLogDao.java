...
public class UserMessageLogDao extends MessageLogDao<UserMessageLog> {
    ...
    public int countByMessageId(String messageId, MSHRole mshRole) {
        TypedQuery<Long> query = this.em.createNamedQuery("UserMessageLog.countByMessageIdAndRole", Long.class);
        query.setParameter(STR_MESSAGE_ID, messageId);
        query.setParameter("MSH_ROLE", mshRole);
