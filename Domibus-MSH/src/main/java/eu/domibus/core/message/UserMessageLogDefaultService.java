...
public class UserMessageLogDefaultService {
    ...
    public UserMessageLog save(UserMessage userMessage, String messageId, String messageStatus, String notificationStatus, String mshRole, Integer maxAttempts, String mpc, String backendName, String endpoint, String service, String action, Boolean sourceMessage, Boolean messageFragment, Boolean scheduled) {
