...
// */
////@Service
//public class MessageRetentionDefaultServiceBck implements MessageRetentionService {
//
//    public static final String MESSAGE_LOGS = "MESSAGE_LOGS";
//    public static final String DELETE_TYPE = "DELETE_TYPE";
//
//    private static final DomibusLogger LOG = DomibusLoggerFactory.getLogger(MessageRetentionDefaultServiceBck.class);
//
//    @Autowired
...
//        if(retentionStrategy.compareTo("")== 0) {
//            return true;
//        }
//        return false;
//    }
...
//     */
//    @Override
//    @Timer(clazz = MessageRetentionDefaultServiceBck.class, value = "retention_deleteExpiredMessages")
//    @Counter(clazz = MessageRetentionDefaultServiceBck.class, value = "retention_deleteExpiredMessages")
...
//        }
//
//        Integer timeout = domibusPropertyProvider.getIntegerProperty(DOMIBUS_RETENTION_WORKER_TIMEOUT);
//
//        if (!storedProcedureEnabled()) {
//            return;
//        }
...
//        DeletionJobRunnable deleteUserMessagesProcedureRunnable = new DeletionJobRunnable(userMessageLogDao, startDate, mpc, maxCount, queryName);
//
