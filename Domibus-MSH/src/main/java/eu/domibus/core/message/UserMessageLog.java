...
//        @NamedQuery(name = "UserMessageLog.findSentUserMessagesOlderThan", query = "select new eu.domibus.core.message.UserMessageLogDto(uml.messageInfo.messageId, uml.messageSubtype, uml.backend) from UserMessageLog uml where (uml.messageStatus = eu.domibus.common.MessageStatus.ACKNOWLEDGED or uml.messageStatus = eu.domibus.common.MessageStatus.SEND_FAILURE) and uml.mpc = :MPC and uml.modificationTime is not null and uml.modificationTime < :DATE"),
        ...
        //@NamedQuery(name = "UserMessageLog.findExpired", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) from UserMessageLog uml join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId where (uml.messageStatus = eu.domibus.common.MessageStatus.ACKNOWLEDGED or uml.messageStatus = eu.domibus.common.MessageStatus.SEND_FAILURE) and uml.deleted is null and uml.mpc = :MPC and uml.modificationTime is not null and uml.modificationTime < :DATE"),


        @NamedQuery(name = "UserMessageLog.findDeletedUserMessagesOlderThan", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) from UserMessageLog uml join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId where uml.messageStatus = eu.domibus.common.MessageStatus.DELETED and uml.deleted is not null and uml.mpc = :MPC and uml.deleted < :DATE"),
        @NamedQuery(name = "UserMessageLog.findUndownloadedUserMessagesOlderThan", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) from UserMessageLog uml join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId where (uml.messageStatus = eu.domibus.common.MessageStatus.RECEIVED or uml.messageStatus = eu.domibus.common.MessageStatus.RECEIVED_WITH_WARNINGS) and uml.deleted is null and uml.mpc = :MPC and uml.received < :DATE"),
        @NamedQuery(name = "UserMessageLog.findDownloadedUserMessagesOlderThan", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) from UserMessageLog uml join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId where (uml.messageStatus = eu.domibus.common.MessageStatus.DOWNLOADED) and uml.mpc = :MPC and uml.downloaded is not null and uml.downloaded < :DATE"),
        @NamedQuery(name = "UserMessageLog.findSentUserMessagesWithPayloadNotClearedOlderThan", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId from UserMessageLog uml where (uml.messageStatus = eu.domibus.common.MessageStatus.ACKNOWLEDGED or uml.messageStatus = eu.domibus.common.MessageStatus.SEND_FAILURE) and uml.deleted is null and uml.mpc = :MPC and uml.modificationTime is not null and uml.modificationTime < :DATE"),
        @NamedQuery(name = "UserMessageLog.findSentUserMessagesOlderThan", query = "select new eu.domibus.core.message.MessageDto(uml.messageInfo.messageId, sm.messageInfo.messageId, sm.receipt.entityId, uml.messageSubtype, uml.backend) from UserMessageLog uml join MessageInfo mi on uml.messageId = mi.refToMessageId join SignalMessage sm on mi.entityId = sm.messageInfo.entityId join Receipt receipt on receipt.entityId = sm.receipt.entityId where (uml.messageStatus = eu.domibus.common.MessageStatus.ACKNOWLEDGED or uml.messageStatus = eu.domibus.common.MessageStatus.SEND_FAILURE) and uml.mpc = :MPC and uml.modificationTime is not null and uml.modificationTime < :DATE"),
