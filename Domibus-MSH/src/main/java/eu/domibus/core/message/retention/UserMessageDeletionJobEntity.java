 ...
 */
@Entity
@Table(name = "TB_USER_MSG_DELETION_JOB")
@NamedQueries({
...
public class UserMessageDeletionJobEntity extends AbstractBaseEntity {
    ...
    public UserMessageDeletionJobEntity(String mpc, Date startRetentionDate, Date endRetentionDate, int maxCount, String procedureName, int jobNumber) {
        this.mpc = mpc;
