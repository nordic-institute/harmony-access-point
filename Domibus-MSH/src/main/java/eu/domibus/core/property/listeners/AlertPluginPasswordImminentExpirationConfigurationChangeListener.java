...
public class AlertPluginPasswordImminentExpirationConfigurationChangeListener implements PluginPropertyChangeListener {
    ...
    public boolean handlesProperty(String propertyName) {
        return StringUtils.startsWithIgnoreCase(propertyName, "domibus.alert.plugin_password.imminent_expiration.");
    }
    ...
    public void propertyValueChanged(String domainCode, String propertyName, String propertyValue) {
        ...
        passwordExpirationAlertsConfigurationHolder.resetConfiguration(AlertType.PLUGIN_PASSWORD_IMMINENT_EXPIRATION, domain);
    }
}
