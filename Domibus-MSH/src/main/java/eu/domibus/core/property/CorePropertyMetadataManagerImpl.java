...
public class CorePropertyMetadataManagerImpl implements DomibusPropertyMetadataManagerSPI {
    ...
    private Map<String, DomibusPropertyMetadata> knownProperties = Arrays.stream(new DomibusPropertyMetadata[]{
            ...
            new DomibusPropertyMetadata(DOMIBUS_RETENTION_WORKER_STORED_PROCEDURE_ENABLED, Type.BOOLEAN, Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_RETENTION_WORKER_STORED_PROCEDURE_TIMEOUT, Type.NUMERIC, Usage.DOMAIN, true),
