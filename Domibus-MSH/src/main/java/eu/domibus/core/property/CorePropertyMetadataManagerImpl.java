...
public class CorePropertyMetadataManagerImpl implements DomibusPropertyMetadataManagerSPI {
    ...
    private Map<String, DomibusPropertyMetadata> knownProperties = Arrays.stream(new DomibusPropertyMetadata[]{
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_CONFIG_LOCATION, DomibusPropertyMetadata.Type.URI),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DEPLOYMENT_CLUSTERED, DomibusPropertyMetadata.Type.BOOLEAN),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, false, DomibusPropertyMetadata.Usage.DOMAIN, false, true),
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_XA_PROPERTY_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, true),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_XA_PROPERTY_url, DomibusPropertyMetadata.Type.URI),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_XA_PROPERTY_URL, DomibusPropertyMetadata.Type.URI),

            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_DRIVER_CLASS_NAME, DomibusPropertyMetadata.Type.CLASS),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_URL, DomibusPropertyMetadata.Type.URI),

            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_USER),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATASOURCE_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY, DomibusPropertyMetadata.Type.CLASS, Module.MSH, false, DomibusPropertyMetadata.Usage.GLOBAL, false, false, false, true),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_PACKAGES_TO_SCAN, DomibusPropertyMetadata.Type.CLASS),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY_HIBERNATE_CONNECTION_DRIVER_CLASS, DomibusPropertyMetadata.Type.CLASS),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY_HIBERNATE_DIALECT, DomibusPropertyMetadata.Type.CLASS),
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY_HIBERNATE_FORMAT_SQL, DomibusPropertyMetadata.Type.BOOLEAN),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY_HIBERNATE_TRANSACTION_FACTORY_CLASS, DomibusPropertyMetadata.Type.CLASS),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_ENTITY_MANAGER_FACTORY_JPA_PROPERTY_HIBERNATE_TRANSACTION_JTA_PLATFORM, DomibusPropertyMetadata.Type.CLASS),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PASSWORD_ENCRYPTION_KEY_LOCATION, DomibusPropertyMetadata.Type.URI, false, DomibusPropertyMetadata.Usage.GLOBAL_AND_DOMAIN, true),

            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_JMS_CONNECTION_FACTORY_SESSION_CACHE_SIZE, DomibusPropertyMetadata.Type.NUMERIC),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_JMS_QUEUE_PULL, DomibusPropertyMetadata.Type.QUEUE),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_JMS_QUEUE_UI_REPLICATION, DomibusPropertyMetadata.Type.QUEUE), //move the use=age from xml ?
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_JMS_QUEUE_ALERT, DomibusPropertyMetadata.Type.QUEUE), //move the use=age from xml ?
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(MESSAGE_FACTORY_CLASS, DomibusPropertyMetadata.Type.CLASS), //move the use=age from xml ?
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_METRICS_MONITOR_JMS_QUEUES_REFRESH_PERIOD, DomibusPropertyMetadata.Type.NUMERIC),
            ...
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_KEYSTORE_LOCATION, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, false),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_KEYSTORE_TYPE, DomibusPropertyMetadata.Usage.DOMAIN, false),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_KEYSTORE_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, true, DomibusPropertyMetadata.Usage.DOMAIN, false, true),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS, DomibusPropertyMetadata.Usage.DOMAIN, false),

            new DomibusPropertyMetadata(DOMIBUS_SECURITY_TRUSTSTORE_LOCATION, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, false),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_TRUSTSTORE_TYPE, DomibusPropertyMetadata.Usage.DOMAIN, false),
            new DomibusPropertyMetadata(DOMIBUS_SECURITY_TRUSTSTORE_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, true, DomibusPropertyMetadata.Usage.DOMAIN, false, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_CERTIFICATE_CRL_EXCLUDED_PROTOCOLS, DomibusPropertyMetadata.Type.COMMA_SEPARATED_LIST, DomibusPropertyMetadata.Usage.DOMAIN, false),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PASSWORD_POLICY_PATTERN, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN_AND_SUPER, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PLUGIN_PASSWORD_POLICY_PATTERN, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_ATTACHMENT_TEMP_STORAGE_LOCATION, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_ATTACHMENT_STORAGE_LOCATION, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, false),
            ...
            new DomibusPropertyMetadata(DOMIBUS_MSH_MESSAGEID_SUFFIX, DomibusPropertyMetadata.Type.DOTTED_NAME, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_SMLZONE, DomibusPropertyMetadata.Type.DOTTED_NAME, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_OASISCLIENT_REGEX_CERTIFICATE_SUBJECT_VALIDATION, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_PARTYID_RESPONDER_ROLE, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_PARTYID_TYPE, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_TRANSPORTPROFILEAS_4, DomibusPropertyMetadata.Type.HYPHENED_NAME, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_JMS_INTERNAL_QUEUE_EXPRESSION, DomibusPropertyMetadata.Type.REGEXP),
            ...
            new DomibusPropertyMetadata(DOMIBUS_SENDER_TRUST_VALIDATION_EXPRESSION, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN, false),
            ...
            new DomibusPropertyMetadata(DOMIBUS_SEND_MESSAGE_MESSAGE_ID_PATTERN, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN, false),
            new DomibusPropertyMetadata(DOMIBUS_PARTYINFO_ROLES_VALIDATION_ENABLED, DomibusPropertyMetadata.Type.BOOLEAN, DomibusPropertyMetadata.Usage.DOMAIN, true),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATE_TIME_PATTERN_ON_RECEIVING, DomibusPropertyMetadata.Type.XSD_DATE_TIME),
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_DATE_TIME_PATTERN_ON_SENDING, DomibusPropertyMetadata.Type.XSD_DATE_TIME),
            ...
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_PROXY_HTTP_HOST, DomibusPropertyMetadata.Type.URI),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PROXY_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD, Module.MSH, true, DomibusPropertyMetadata.Usage.GLOBAL, false, false, true, false),
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_PROXY_NON_PROXY_HOSTS),

            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_JDBC_DATASOURCE_JNDI_NAME, DomibusPropertyMetadata.Type.JNDI),
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_JDBC_DATASOURCE_QUARTZ_JNDI_NAME, DomibusPropertyMetadata.Type.JNDI),
            ...
            new DomibusPropertyMetadata(DOMIBUS_SEND_MESSAGE_FAILURE_DELETE_PAYLOAD, DomibusPropertyMetadata.Type.BOOLEAN, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PAYLOAD_TEMP_JOB_RETENTION_EXCLUDE_REGEX, DomibusPropertyMetadata.Type.REGEXP, DomibusPropertyMetadata.Usage.DOMAIN, false),
            ...
            new DomibusPropertyMetadata(DOMIBUS_PAYLOAD_TEMP_JOB_RETENTION_DIRECTORIES, DomibusPropertyMetadata.Type.URI, DomibusPropertyMetadata.Usage.DOMAIN, false),
            ...
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_USER_INPUT_BLACK_LIST, DomibusPropertyMetadata.Type.REGEXP),
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_USER_INPUT_WHITE_LIST, DomibusPropertyMetadata.Type.REGEXP),
            ...
            new DomibusPropertyMetadata(DOMIBUS_MONITORING_CONNECTION_PARTY_ENABLED, DomibusPropertyMetadata.Type.COMMA_SEPARATED_LIST, DomibusPropertyMetadata.Usage.DOMAIN, true),
            ...
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_ALERT_SENDER_SMTP_URL, DomibusPropertyMetadata.Type.URI),
            ...
            DomibusPropertyMetadata.getGlobalProperty(DOMIBUS_ALERT_SENDER_SMTP_PASSWORD, DomibusPropertyMetadata.Type.PASSWORD),
