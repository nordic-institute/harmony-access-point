...
public class CommonsDataLoader implements DataLoader {
    ...
    private RegistryBuilder<ConnectionSocketFactory> setConnectionManagerSchemeHttps(
        ...
        try {
            ...
            SSLContextBuilder sslContextBuilder = SSLContextBuilder.create().useProtocol(sslProtocol);
    ...
    @Override
    public DataLoader.DataAndUrl get(final List<String> urlStrings) {
  ...
  /*  *//**
     ...
     *//*
    public eu.europa.esig.dss.client.http.commons.CommonsDataLoader addAuthentication(final String host, final int port, final String scheme, final String login, final String password) {
     ...
     */
    public void propagateAuthentication(final eu.europa.esig.dss.client.http.commons.CommonsDataLoader commonsDataLoader) {
