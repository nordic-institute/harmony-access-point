...
public class DomainSchedulerFactoryConfiguration {
    ...
    public CronTriggerFactoryBean activateSuspendedUserTrigger() {
        ...
        obj.setCronExpression(domibusPropertyProvider.getDomainProperty(DOMIBUS_ACCOUNT_UNLOCK_CRON));
        return obj;
    }
    ...
    public CronTriggerFactoryBean activateSuspendedPluginUserTrigger() {
        ...
        obj.setCronExpression(domibusPropertyProvider.getDomainProperty(DOMIBUS_PLUGIN_ACCOUNT_UNLOCK_CRON));
        return obj;
    }
    ...
    public CronTriggerFactoryBean saveCertificateAndLogRevocationTrigger() {
        ...
        obj.setCronExpression(domibusPropertyProvider.getDomainProperty(DOMIBUS_CERTIFICATE_CHECK_CRON));
        return obj;
    }
    ...
    public CronTriggerFactoryBean uiReplicationTrigger() {
        ...
        obj.setCronExpression(domibusPropertyProvider.getDomainProperty(DOMIBUS_UI_REPLICATION_SYNC_CRON));
