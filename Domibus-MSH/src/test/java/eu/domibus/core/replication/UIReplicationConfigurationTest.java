...
public class UIReplicationConfigurationTest {

    @Tested
    UIReplicationConfiguration uiReplicationConfiguration;
    ...
    public void alertJmsListenerContainerFactory(@Injectable ConnectionFactory connectionFactory,
        ...
        uiReplicationConfiguration.alertJmsListenerContainerFactory(connectionFactory, transactionManager, domibusPropertyProvider, jackson2MessageConverter, internalDestinationResolver);
