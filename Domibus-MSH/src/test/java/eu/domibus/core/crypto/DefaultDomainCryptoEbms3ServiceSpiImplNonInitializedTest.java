...
public class DefaultDomainCryptoEbms3ServiceSpiImplNonInitializedTest {
    ...
    public void persistsTheTrustStoreAfterAddingCertificate(@Injectable X509Certificate certificate) {
        ...
        new MockUp<DefaultDomainCryptoServiceSpiImpl>() {
            ...
            @Mock
            boolean addCertificate(Invocation invocation, X509Certificate x509Certificate, String alias, boolean overwrite) {
                invocation.proceed();
            ...
            @Mock
            boolean doAddCertificate(X509Certificate certificate, String alias, boolean overwrite) {
                return true;
            }
    ...
    public void addsMultipleCertificatesIntoTheTrustStore(@Injectable X509Certificate firstCertificate, @Injectable X509Certificate secondCertificate,
        ...
        new MockUp<DefaultDomainCryptoServiceSpiImpl>() {
            ...
            @Mock
            boolean addCertificate(Invocation invocation, List<CertificateEntry> certificates, boolean overwrite) {
                invocation.proceed();
        ...
        new Expectations() {{
            first.getCertificate();
            result = firstCertificate;
            first.getAlias();
            result = "first";
            second.getCertificate();
            result = secondCertificate;
            second.getAlias();
            result = "second";
        }};
