...
// add mapper dependant bean
@ContextConfiguration(classes = {JsonFormatterConfiguration.class, EArchiveBatchUtils.class})
public class EArchiveBatchMapperTest extends AbstractMapperTest {

    @Autowired
    private ObjectMapper objectMapper;
    @Autowired
    private EArchiveBatchMapper testInstance;
