...
public class CertificateServiceImplTest {
    ...
    public void testGetTrustStoreEntries(@Injectable final KeyStore trustStore,
                                         @Injectable final Enumeration<String> aliasEnum,
    ...
    @Test
    public void sendCertificateExpiredAlertsModuleInactive(final @Injectable ExpiredCertificateModuleConfiguration expiredCertificateConfiguration,
    ...
    @Test
    public void sendCertificateImminentExpirationAlertsModuleInactive(final @Injectable ExpiredCertificateModuleConfiguration expiredCertificateConfiguration,
                                                                      @Injectable LocalDateTime dateTime, @Injectable final Certificate certificate) {
        new Expectations() {{
    ...
    public void persistsTheTrustStoreAfterRemovingCertificate(@Injectable KeyStore trustStore) {
        ...
        new MockUp<CertificateServiceImpl>() {
            ...
            @Mock
            void persistTrustStore(Invocation invocation, KeyStore truststore, String name) {
    ...
    public void doesNotPersistTheTrustStoreWhenRemovingCertificateThatDoesNotAlterItsContent(@Injectable KeyStore trustStore,
        ...
        new MockUp<CertificateServiceImpl>() {
            ...
            @Mock
            void persistTrustStore(KeyStore truststore, String name) {
    ...
    public void doesNotPersistTheTrustStoreWhenAddingCertificateThatDoesNotAlterItsContent(@Injectable List<CertificateEntry> certificates,
        ...
        new MockUp<CertificateServiceImpl>() {
            ...
            @Mock
            void persistTrustStore(KeyStore truststore, String trustName) {
    ...
    @Test
    public void loadTrustStoreFromContent(@Injectable InputStream contentStream) {
        byte[] content = {1, 2, 3};
    ...
    @Test
    public void replaceTrustStore(@Injectable String fileName, @Injectable byte[] fileContent, @Injectable TruststoreEntity entity) {
    ...
    public void testBackupTruststore() throws IOException {
        ...
        new Verifications() {{
//            backupService.backupFileInLocation(testFile, TRUST_STORE_BACKUP_LOCATION);
//            times = 1;
        }};
    }
...
//            times = 0;
    ...
    @Test
    public void doAddCertificates(@Injectable KeyStore trustStore, @Injectable String trustStorePassword, @Injectable String trustStoreLocation,
        ...
        boolean result = certificateService.doAddCertificates(DOMIBUS_TRUSTSTORE_NAME, certificates, overwrite);
    ...
    @Test
    public void doAddCertificatesNotAdded(@Injectable KeyStore trustStore, @Injectable String trustStorePassword, @Injectable String trustStoreLocation,
                                          @Injectable CertificateEntry cert1, @Injectable CertificateEntry cert2) {
    ...
    public void doRemoveCertificates(@Injectable KeyStore trustStore) {
        ...
        boolean result = certificateService.doRemoveCertificates(DOMIBUS_TRUSTSTORE_NAME, certificates);
