...
public class DomibusPropertiesEbms3ServiceTest {

    private static final DomibusLogger LOG = DomibusLoggerFactory.getLogger(DomibusPropertiesEbms3ServiceTest.class);
