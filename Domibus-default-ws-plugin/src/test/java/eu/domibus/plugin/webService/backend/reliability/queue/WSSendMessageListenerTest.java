...
import static eu.domibus.plugin.webService.backend.WSBackendMessageType.RECEIVE_SUCCESS;
import static eu.domibus.plugin.webService.backend.WSBackendMessageType.SUBMIT_MESSAGE;
