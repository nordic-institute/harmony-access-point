...
public class DMessages {
	...
	public static final String PLUGINUSER_DUPLICATE_USERNAME_1 = "The operation 'update plugin users' completed with errors. [DOM_001]:Cannot add user %s because it already exists in the default domain.";
	public static final String PLUGINUSER_DUPLICATE_USERNAME = "The operation 'update plugin users' completed with errors. [DOM_001]:Cannot add user %s because this name already exists.";
	...
	public static final String USER_DUPLICATE_USERNAME = "The operation update users not completed successfully. [DOM_001]:Cannot add user %s because this name already exists in the %s domain.";
