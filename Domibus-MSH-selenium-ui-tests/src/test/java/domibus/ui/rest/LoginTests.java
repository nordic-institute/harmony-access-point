...
public class LoginTests extends RestTest {
	...
	public void loginValidUser(String role) throws IOException {
	...
	@Test(dataProvider = "userProvider")
	public void loginDeletedUser(String role) throws IOException {
	...
	@Test(dataProvider = "userProvider")
	public void loginInactiveUser(String role) throws IOException {
	...
	@Test(dataProvider = "userProvider")
	public void loginInactiveAndDeletedUser(String role) throws IOException {
	...
	@Test(dataProvider = "userProvider")
	public void loginBlockedAccount(String role) throws IOException {
	...
	@Test(dataProvider = "userProvider")
	public void loginBlockedInactiveAndDeleted(String role) throws IOException {
