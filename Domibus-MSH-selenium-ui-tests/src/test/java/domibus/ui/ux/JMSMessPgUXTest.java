...
public class JMSMessPgUXTest extends BaseUXTest {
    ...
    private String getSelector(HashMap<String, String> messInfo) throws JSONException {
        //String selectorTemplate = "MESSAGE_ID='%s' AND JMSTimestamp=%s";
        String selectorTemplate = "MESSAGE_ID='%s'";
        ...
        //String timestamp = new JSONObject(jmsProp).getString("JMSTimestamp");

//		return String.format(selectorTemplate, messageId, jmsMessageID);
        //return String.format(selectorTemplate, messageId, timestamp);
        return String.format(selectorTemplate, messageId);
