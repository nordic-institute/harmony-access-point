...
public class DssExtensionPropertyManager extends DomibusPropertyExtServiceDelegateAbstract implements DomibusPropertyManagerExt {
    ...
    public DssExtensionPropertyManager() {
        List<DomibusPropertyMetadataDTO> allProperties = Arrays.asList(
                ...
                new DomibusPropertyMetadataDTO(AUTHENTICATION_DSS_OFFICIAL_JOURNAL_CONTENT_KEYSTORE_PASSWORD, DomibusPropertyMetadataDTO.Type.STRING, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
                new DomibusPropertyMetadataDTO(AUTHENTICATION_DSS_LOTL_ROOT_SCHEME_INFO_URI, DomibusPropertyMetadataDTO.Type.STRING, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
                ...
                new DomibusPropertyMetadataDTO(EXCLUDE_PIVOT_FILE_REGEX, DomibusPropertyMetadataDTO.Type.STRING, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
                ...
                new DomibusPropertyMetadataDTO(DSS_SSL_TRUST_STORE_PASSWORD, DomibusPropertyMetadataDTO.Type.STRING, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
                ...
                new DomibusPropertyMetadataDTO(DSS_SSL_CACERT_PASSWORD, DomibusPropertyMetadataDTO.Type.STRING, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
