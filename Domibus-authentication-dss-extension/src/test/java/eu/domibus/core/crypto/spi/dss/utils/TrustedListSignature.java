...
public class TrustedListSignature {
    ...
    public TrustedListSignature() throws IOException {
        ...
        Pkcs12SignatureToken signingToken = new Pkcs12SignatureToken("C:\\tmp\\gateway_keystore.jks", new KeyStore.PasswordProtection("test123".toCharArray()));
        DSSDocument trustedList = new FileDocument("src/test/resources/CUST.xml");
