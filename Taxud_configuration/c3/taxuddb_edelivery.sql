...
CREATE TABLE MS_MS2_VM_WLSTORE (
  ...
  CREATE TABLE MS_MS6_VM_WLSTORE (
  id     int  not null primary key,
  type   int  not null,
  handle int  not null,
  record blob not null
  ...
  CREATE TABLE MS_MS7_VM_WLSTORE (
  id     int  not null primary key,
  type   int  not null,
  handle int  not null,
  record blob not null
  ...
  CREATE TABLE MS_MS8_VM_WLSTORE (
  id     int  not null primary key,
  type   int  not null,
  handle int  not null,
  record blob not null
  ...
  CREATE TABLE MS_MS9_VM_WLSTORE (
  id     int  not null primary key,
  type   int  not null,
  handle int  not null,
  record blob not null
  ...
  CREATE TABLE MS_MS10_VM_WLSTORE (
  id     int  not null primary key,
  type   int  not null,
  handle int  not null,
  record blob not null
  ...
  ENABLE STORAGE IN ROW NOCACHE)
  PARTITION BY HASH(id) PARTITIONS 8;
-- Changeset src/main/resources/db/changelog-4.2.xml::changelog-3.2-delta-1::martifp
-- create sequence
CREATE SEQUENCE HIBERNATE_SEQUENCE START WITH 10 INCREMENT BY 50 MINVALUE 1 MAXVALUE 9223372036854775806 CACHE 1000 NOORDER scale;
...
-- Changeset src/main/resources/db/changelog-4.2.xml::1564477107969-13::Catalin Enache
-- create Domibus tables
CREATE TABLE TB_ACTION (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_ACTION PRIMARY KEY (ID_PK));

CREATE TABLE TB_ACTION_AUDIT (ID_PK NUMBER(38, 0) NOT NULL, AUDIT_TYPE VARCHAR2(31) NOT NULL, ENTITY_ID VARCHAR2(255), MODIFICATION_TYPE VARCHAR2(255), REVISION_DATE TIMESTAMP, USER_NAME VARCHAR2(255), FROM_QUEUE VARCHAR2(255), TO_QUEUE VARCHAR2(255), CONSTRAINT PK_TB_ACTION_AUDIT PRIMARY KEY (ID_PK));

CREATE TABLE TB_AGREEMENT (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), TYPE VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_AGREEMENT PRIMARY KEY (ID_PK));

CREATE TABLE TB_ALERT (ID_PK NUMBER(38, 0) NOT NULL, ALERT_TYPE VARCHAR2(50) NOT NULL, ATTEMPTS_NUMBER INTEGER, MAX_ATTEMPTS_NUMBER INTEGER NOT NULL, PROCESSED NUMBER(1), PROCESSED_TIME TIMESTAMP, CREATION_TIME TIMESTAMP, REPORTING_TIME TIMESTAMP, REPORTING_TIME_FAILURE TIMESTAMP, NEXT_ATTEMPT TIMESTAMP, ALERT_STATUS VARCHAR2(50) NOT NULL, ALERT_LEVEL VARCHAR2(20) NOT NULL, CONSTRAINT PK_TB_ALERT PRIMARY KEY (ID_PK));

CREATE TABLE TB_AUTHENTICATION_ENTRY (ID_PK NUMBER(38, 0) NOT NULL, CERTIFICATE_ID VARCHAR2(255), USERNAME VARCHAR2(255), PASSWD VARCHAR2(255), AUTH_ROLES VARCHAR2(255) NOT NULL, ORIGINAL_USER VARCHAR2(255), BACKEND VARCHAR2(255), PASSWORD_CHANGE_DATE TIMESTAMP, DEFAULT_PASSWORD NUMBER(1) DEFAULT 0, ATTEMPT_COUNT INTEGER DEFAULT 0 NOT NULL, SUSPENSION_DATE TIMESTAMP, USER_ENABLED NUMBER(1) DEFAULT 1 NOT NULL, CONSTRAINT PK_TB_AUTHENTICATION_ENTRY PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_BACKEND_FILTER (ID_PK NUMBER(38, 0) NOT NULL, BACKEND_NAME VARCHAR2(255), PRIORITY INTEGER, CONSTRAINT PK_TB_BACKEND_FILTER PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_BUSINESS_PROCESS (ID_PK NUMBER(38, 0) NOT NULL, CONSTRAINT PK_TB_BUSINESS_PROCESS PRIMARY KEY (ID_PK));

CREATE TABLE TB_CERTIFICATE (ID_PK NUMBER(38, 0) NOT NULL, CERTIFICATE_ALIAS VARCHAR2(255) NOT NULL, NOT_VALID_BEFORE_DATE TIMESTAMP, NOT_VALID_AFTER_DATE TIMESTAMP, REVOKE_NOTIFICATION_DATE TIMESTAMP, ALERT_IMM_NOTIFICATION_DATE TIMESTAMP, ALERT_EXP_NOTIFICATION_DATE TIMESTAMP, CERTIFICATE_STATUS VARCHAR2(255) NOT NULL, CERTIFICATE_TYPE VARCHAR2(255) NOT NULL, CONSTRAINT PK_TB_CERTIFICATE PRIMARY KEY (ID_PK));

CREATE TABLE TB_COMMAND (ID_PK NUMBER(38, 0) NOT NULL, SERVER_NAME VARCHAR2(255) NOT NULL, COMMAND_NAME VARCHAR2(255) NOT NULL, DOMAIN VARCHAR2(255) NOT NULL, CREATION_TIME TIMESTAMP, CONSTRAINT PK_TB_COMMAND PRIMARY KEY (ID_PK));

CREATE TABLE TB_COMMAND_PROPERTY (PROPERTY_NAME VARCHAR2(50) NOT NULL, PROPERTY_VALUE VARCHAR2(255), FK_COMMAND NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_CONFIGURATION (ID_PK NUMBER(38, 0) NOT NULL, FK_BUSINESSPROCESSES NUMBER(38, 0), FK_PARTY NUMBER(38, 0), CONSTRAINT PK_TB_CONFIGURATION PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_CONFIGURATION_RAW (ID_PK NUMBER(38, 0) NOT NULL, CONFIGURATION_DATE TIMESTAMP, XML BLOB, DESCRIPTION VARCHAR2(255) DEFAULT '', CONSTRAINT PK_TB_CONFIGURATION_RAW PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_ENCRYPTION_KEY (ID_PK NUMBER(38, 0) NOT NULL, KEY_USAGE VARCHAR2(255), SECRET_KEY BLOB NOT NULL, INIT_VECTOR BLOB NOT NULL, CONSTRAINT PK_TB_ENCRYPTION_KEY PRIMARY KEY (ID_PK));

CREATE TABLE TB_ERROR (ID_PK NUMBER(38, 0) NOT NULL, CATEGORY VARCHAR2(255), DESCRIPTION_LANG VARCHAR2(255), DESCRIPTION_VALUE VARCHAR2(255), ERROR_CODE VARCHAR2(255), ERROR_DETAIL CLOB, ORIGIN VARCHAR2(255), REF_TO_MESSAGE_ID VARCHAR2(255), SEVERITY VARCHAR2(255), SHORT_DESCRIPTION VARCHAR2(255), SIGNALMESSAGE_ID NUMBER(38, 0), CONSTRAINT PK_TB_ERROR PRIMARY KEY (ID_PK));

CREATE TABLE TB_ERROR_HANDLING (ID_PK NUMBER(38, 0) NOT NULL, BUSINESS_ERROR_NOTIFY_CONSUMER NUMBER(1), BUSINESS_ERROR_NOTIFY_PRODUCER NUMBER(1), DELIVERY_FAIL_NOTIFY_PRODUCER NUMBER(1), ERROR_AS_RESPONSE NUMBER(1), NAME VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_ERROR_HANDLING PRIMARY KEY (ID_PK));

CREATE TABLE TB_ERROR_LOG (ID_PK NUMBER(38, 0) NOT NULL, ERROR_CODE VARCHAR2(255), ERROR_DETAIL VARCHAR2(255), ERROR_SIGNAL_MESSAGE_ID VARCHAR2(255), MESSAGE_IN_ERROR_ID VARCHAR2(255), MSH_ROLE VARCHAR2(255), NOTIFIED TIMESTAMP, TIME_STAMP TIMESTAMP, CONSTRAINT PK_TB_ERROR_LOG PRIMARY KEY (ID_PK));

CREATE TABLE TB_EVENT (ID_PK NUMBER(38, 0) NOT NULL, EVENT_TYPE VARCHAR2(50) NOT NULL, REPORTING_TIME TIMESTAMP, LAST_ALERT_DATE TIMESTAMP, CONSTRAINT PK_TB_EVENT PRIMARY KEY (ID_PK));

CREATE TABLE TB_EVENT_ALERT (FK_EVENT NUMBER(38, 0) NOT NULL, FK_ALERT NUMBER(38, 0) NOT NULL, CONSTRAINT PK_EVENT_ALERT PRIMARY KEY (FK_EVENT, FK_ALERT));

CREATE TABLE TB_EVENT_PROPERTY (ID_PK NUMBER(38, 0) NOT NULL, PROPERTY_TYPE VARCHAR2(50) NOT NULL, FK_EVENT NUMBER(38, 0) NOT NULL, DTYPE VARCHAR2(31), STRING_VALUE VARCHAR2(255), DATE_VALUE TIMESTAMP, CONSTRAINT PK_TB_EVENT_PROPERTY PRIMARY KEY (ID_PK));

CREATE TABLE TB_JOIN_PAYLOAD_PROFILE (FK_PAYLOAD NUMBER(38, 0) NOT NULL, FK_PROFILE NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_JOIN_PROCESS_INIT_PARTY (PROCESS_FK NUMBER(38, 0) NOT NULL, PARTY_FK NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_JOIN_PROCESS_LEG (PROCESS_FK NUMBER(38, 0) NOT NULL, LEG_FK NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_JOIN_PROCESS_RESP_PARTY (PROCESS_FK NUMBER(38, 0) NOT NULL, PARTY_FK NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_JOIN_PROPERTY_SET (PROPERTY_FK NUMBER(38, 0) NOT NULL, SET_FK NUMBER(38, 0) NOT NULL);

CREATE TABLE TB_LEG (ID_PK NUMBER(38, 0) NOT NULL, COMPRESS_PAYLOADS NUMBER(1), NAME VARCHAR2(255), FK_ACTION NUMBER(38, 0), FK_MPC NUMBER(38, 0), FK_ERROR_HANDLING NUMBER(38, 0), FK_PAYLOAD_PROFILE NUMBER(38, 0), FK_PROPERTY_SET NUMBER(38, 0), FK_RECEPTION_AWARENESS NUMBER(38, 0), FK_RELIABILITY NUMBER(38, 0), FK_SECURITY NUMBER(38, 0), FK_SERVICE NUMBER(38, 0), FK_BUSINESSPROCESS NUMBER(38, 0), FK_SPLITTING NUMBER(38, 0), CONSTRAINT PK_TB_LEG PRIMARY KEY (ID_PK));

CREATE TABLE TB_LEG_TB_MPC (LEGCONFIGURATION_ID_PK NUMBER(38, 0) NOT NULL, PARTYMPCMAP_ID_PK NUMBER(38, 0) NOT NULL, PARTYMPCMAP_KEY NUMBER(38, 0) NOT NULL, CONSTRAINT PRIMARY_12 PRIMARY KEY (LEGCONFIGURATION_ID_PK, PARTYMPCMAP_KEY));

CREATE TABLE TB_MEP (ID_PK NUMBER(38, 0) NOT NULL, LEG_COUNT INTEGER, NAME VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_MEP PRIMARY KEY (ID_PK));

CREATE TABLE TB_MEP_BINDING (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_MEP_BINDING PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_ACKNW (ID_PK NUMBER(38, 0) NOT NULL, MESSAGE_ID VARCHAR2(255), FROM_VALUE VARCHAR2(255), TO_VALUE VARCHAR2(255), CREATE_DATE TIMESTAMP, CREATE_USER VARCHAR2(255), ACKNOWLEDGE_DATE TIMESTAMP, CONSTRAINT PK_TB_MESSAGE_ACKNW PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_ACKNW_PROP (ID_PK NUMBER(38, 0) NOT NULL, PROPERTY_NAME VARCHAR2(255), PROPERTY_VALUE VARCHAR2(255), FK_MSG_ACKNOWLEDGE NUMBER(38, 0), CONSTRAINT PK_TB_MESSAGE_ACKNW_PROP PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_FRAGMENT (ID_PK NUMBER(38, 0) NOT NULL, GROUP_ID VARCHAR2(255), FRAGMENT_NUMBER INTEGER, CONSTRAINT PK_TB_MESSAGE_FRAGMENT PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_GROUP (ID_PK NUMBER(38, 0) NOT NULL, GROUP_ID VARCHAR2(255) NOT NULL, MSH_ROLE VARCHAR2(255), SOURCE_MESSAGE_ID VARCHAR2(255), MESSAGE_SIZE NUMBER(38, 0), FRAGMENT_COUNT INTEGER, SENT_FRAGMENTS INTEGER, RECEIVED_FRAGMENTS INTEGER, COMPRESSION_ALGORITHM VARCHAR2(255), COMPRESSED_MESSAGE_SIZE NUMBER(38, 0), SOAP_ACTION VARCHAR2(255), FK_MESSAGE_HEADER_ID NUMBER(38, 0), REJECTED NUMBER(1), EXPIRED NUMBER(1), CONSTRAINT PK_TB_MESSAGE_GROUP PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_MESSAGE_HEADER (ID_PK NUMBER(38, 0) NOT NULL, BOUNDARY VARCHAR2(255), "START" VARCHAR2(255), CONSTRAINT PK_TB_MESSAGE_HEADER PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_USER_MESSAGE_LOG (ID_PK NUMBER(38, 0) NOT NULL, DELETED TIMESTAMP, MESSAGE_ID VARCHAR2(255), MESSAGE_STATUS VARCHAR2(255), MESSAGE_TYPE VARCHAR2(255), MPC VARCHAR2(255), MSH_ROLE VARCHAR2(255), NEXT_ATTEMPT TIMESTAMP, NOTIFICATION_STATUS VARCHAR2(255), RECEIVED TIMESTAMP, RESTORED TIMESTAMP, DOWNLOADED TIMESTAMP, FAILED TIMESTAMP, SEND_ATTEMPTS INTEGER, SEND_ATTEMPTS_MAX INTEGER, BACKEND VARCHAR2(255), ENDPOINT VARCHAR2(255), CREATED_BY VARCHAR2(255), MESSAGE_SUBTYPE VARCHAR2(255), SOURCE_MESSAGE NUMBER(1), MESSAGE_FRAGMENT NUMBER(1), SCHEDULED NUMBER(1), CONSTRAINT PK_USER_MESSAGE_LOG PRIMARY KEY (ID_PK));

COMMENT ON COLUMN TB_USER_MESSAGE_LOG.SOURCE_MESSAGE IS 'true if the message is a SourceMessage';

COMMENT ON COLUMN TB_USER_MESSAGE_LOG.MESSAGE_FRAGMENT IS 'true if the message is a message fragment';

COMMENT ON COLUMN TB_USER_MESSAGE_LOG.SCHEDULED IS 'true if the message is already scheduled to be sent';

CREATE TABLE TB_SIGNAL_MESSAGE_LOG (ID_PK NUMBER(38, 0) NOT NULL, DELETED TIMESTAMP, MESSAGE_ID VARCHAR2(255), MESSAGE_STATUS VARCHAR2(255), MESSAGE_TYPE VARCHAR2(255), MPC VARCHAR2(255), MSH_ROLE VARCHAR2(255), NEXT_ATTEMPT TIMESTAMP, NOTIFICATION_STATUS VARCHAR2(255), RECEIVED TIMESTAMP, RESTORED TIMESTAMP, DOWNLOADED TIMESTAMP, FAILED TIMESTAMP, SEND_ATTEMPTS INTEGER, SEND_ATTEMPTS_MAX INTEGER, BACKEND VARCHAR2(255), ENDPOINT VARCHAR2(255), CREATED_BY VARCHAR2(255), MESSAGE_SUBTYPE VARCHAR2(255), SOURCE_MESSAGE NUMBER(1), MESSAGE_FRAGMENT NUMBER(1), SCHEDULED NUMBER(1), CONSTRAINT PK_SIGNAL_MESSAGE_LOG PRIMARY KEY (ID_PK));

COMMENT ON COLUMN TB_SIGNAL_MESSAGE_LOG.SOURCE_MESSAGE IS 'true if the message is a SourceMessage';

COMMENT ON COLUMN TB_SIGNAL_MESSAGE_LOG.MESSAGE_FRAGMENT IS 'true if the message is a message fragment';

COMMENT ON COLUMN TB_SIGNAL_MESSAGE_LOG.SCHEDULED IS 'true if the message is already scheduled to be sent';

CREATE TABLE TB_MESSAGE_PROPERTY (ID_PK NUMBER(38, 0) NOT NULL, DATATYPE VARCHAR2(255), KEY_ VARCHAR2(255), NAME VARCHAR2(255), REQUIRED_ NUMBER(1), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_MESSAGE_PROPERTY PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_PROPERTY_SET (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_MESSAGE_PROPERTY_SET PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGE_UI (ID_PK NUMBER(38, 0) NOT NULL, MESSAGE_ID VARCHAR2(255), MESSAGE_STATUS VARCHAR2(255), NOTIFICATION_STATUS VARCHAR2(255) NOT NULL, MSH_ROLE VARCHAR2(255) NOT NULL, MESSAGE_TYPE VARCHAR2(255) NOT NULL, DELETED TIMESTAMP, RECEIVED TIMESTAMP, SEND_ATTEMPTS INTEGER, SEND_ATTEMPTS_MAX INTEGER, NEXT_ATTEMPT TIMESTAMP, CONVERSATION_ID VARCHAR2(255), FROM_ID VARCHAR2(255) NOT NULL, TO_ID VARCHAR2(255) NOT NULL, FROM_SCHEME VARCHAR2(255), TO_SCHEME VARCHAR2(255), REF_TO_MESSAGE_ID VARCHAR2(255), FAILED TIMESTAMP, RESTORED TIMESTAMP, MESSAGE_SUBTYPE VARCHAR2(255), LAST_MODIFIED TIMESTAMP DEFAULT sysdate NOT NULL, LAST_MODIFIED2 TIMESTAMP DEFAULT sysdate NOT NULL, CONSTRAINT PK_TB_MESSAGE_UI PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGING (ID_PK NUMBER(38, 0) NOT NULL, ID VARCHAR2(255), CONSTRAINT PK_TB_MESSAGING PRIMARY KEY (ID_PK));

CREATE TABLE TB_MESSAGING_LOCK (ID_PK NUMBER(38, 0) NOT NULL, MESSAGE_TYPE VARCHAR2(10), MESSAGE_RECEIVED TIMESTAMP, MESSAGE_STATE VARCHAR2(10), MESSAGE_ID VARCHAR2(255), INITIATOR VARCHAR2(255), MPC VARCHAR2(255), SEND_ATTEMPTS INTEGER, SEND_ATTEMPTS_MAX INTEGER, NEXT_ATTEMPT TIMESTAMP, MESSAGE_STALED TIMESTAMP, CONSTRAINT PK_TB_MESSAGING_LOCK PRIMARY KEY (ID_PK));

CREATE TABLE TB_MPC (ID_PK NUMBER(38, 0) NOT NULL, DEFAULT_MPC NUMBER(1), IS_ENABLED NUMBER(1), NAME VARCHAR2(255), QUALIFIED_NAME VARCHAR2(255), RETENTION_DOWNLOADED INTEGER, RETENTION_UNDOWNLOADED INTEGER, FK_CONFIGURATION NUMBER(38, 0), CONSTRAINT PK_TB_MPC PRIMARY KEY (ID_PK));

CREATE TABLE TB_PARTY (ID_PK NUMBER(38, 0) NOT NULL, ENDPOINT VARCHAR2(255), NAME VARCHAR2(255), "PASSWORD" VARCHAR2(255), USERNAME VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_PARTY PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_PARTY_ID (ID_PK NUMBER(38, 0) NOT NULL, DIRECTION VARCHAR2(255), TYPE VARCHAR2(255), VALUE VARCHAR2(255), USER_MESSAGE_ID NUMBER(38, 0), CONSTRAINT PK_TB_PARTY_ID PRIMARY KEY (ID_PK));

CREATE TABLE TB_PARTY_IDENTIFIER (ID_PK NUMBER(38, 0) NOT NULL, PARTY_ID VARCHAR2(255), FK_PARTY_ID_TYPE NUMBER(38, 0), FK_PARTY NUMBER(38, 0), CONSTRAINT PK_TB_PARTY_IDENTIFIER PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_PARTY_ID_TYPE (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_PARTY_ID_TYPE PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_RAWMESSAGE (ID_PK NUMBER(38, 0) NOT NULL, RAWENVELOPE VARCHAR2(500), RAWPAYLOAD BLOB, CONSTRAINT PK_TB_RAWMESSAGE PRIMARY KEY (ID_PK));

CREATE TABLE TB_PART_INFO (ID_PK NUMBER(38, 0) NOT NULL, BINARY_DATA BLOB, DESCRIPTION_LANG VARCHAR2(255), DESCRIPTION_VALUE VARCHAR2(255), HREF VARCHAR2(255), IN_BODY NUMBER(1), SCHEMA_LOCATION VARCHAR2(255), SCHEMA_NAMESPACE VARCHAR2(255), SCHEMA_VERSION VARCHAR2(255), MESSAGE_ID NUMBER(38, 0), FILENAME VARCHAR2(255), MIME VARCHAR2(255) NOT NULL, PART_ORDER INTEGER DEFAULT 0 NOT NULL, ENCRYPTED NUMBER(1) DEFAULT 0, CONSTRAINT PK_TB_PART_INFO PRIMARY KEY (ID_PK));

CREATE TABLE TB_PAYLOAD (ID_PK NUMBER(38, 0) NOT NULL, CID VARCHAR2(255), IN_BODY NUMBER(1), MAX_SIZE INTEGER, MIME_TYPE VARCHAR2(255), NAME VARCHAR2(255), REQUIRED_ NUMBER(1), SCHEMA_FILE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_PAYLOAD PRIMARY KEY (ID_PK));

CREATE TABLE TB_PAYLOAD_PROFILE (ID_PK NUMBER(38, 0) NOT NULL, MAX_SIZE INTEGER, NAME VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_PAYLOAD_PROFILE PRIMARY KEY (ID_PK));

CREATE TABLE TB_PLUGIN_USER_PASSWD_HISTORY (ID_PK NUMBER(38, 0) NOT NULL, USER_ID NUMBER(38, 0) NOT NULL, USER_PASSWORD VARCHAR2(255) NOT NULL, PASSWORD_CHANGE_DATE TIMESTAMP, CONSTRAINT PK_TB_PLUGIN_USER_PASSWD_HISTO PRIMARY KEY (ID_PK));

CREATE TABLE TB_PROCESS (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), FK_AGREEMENT NUMBER(38, 0), FK_INITIATOR_ROLE NUMBER(38, 0), FK_MEP NUMBER(38, 0), FK_MEP_BINDING NUMBER(38, 0), FK_RESPONDER_ROLE NUMBER(38, 0), FK_BUSINESSPROCESS NUMBER(38, 0), USE_DYNAMIC_INITIATOR NUMBER(1) NOT NULL, USE_DYNAMIC_RESPONDER NUMBER(1) NOT NULL, CONSTRAINT PK_TB_PROCESS PRIMARY KEY (ID_PK));

CREATE TABLE TB_USER_MESSAGE_PROPERTY (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255) NOT NULL, VALUE VARCHAR2(255), TYPE VARCHAR2(255), MESSAGE_ID NUMBER(38, 0), CONSTRAINT PK_TB_UMSG_PROPERTY PRIMARY KEY (ID_PK));

CREATE TABLE TB_PART_INFO_PROPERTY (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255) NOT NULL, VALUE VARCHAR2(255), TYPE VARCHAR2(255), PART_INFO_ID NUMBER(38, 0), CONSTRAINT PK_TB_PART_PROPERTY PRIMARY KEY (ID_PK));

CREATE TABLE TB_RAWENVELOPE_LOG (ID_PK NUMBER(38, 0) NOT NULL, USERMESSAGE_ID_FK NUMBER(38, 0), SIGNALMESSAGE_ID_FK NUMBER(38, 0), RAW_XML CLOB, MESSAGE_ID VARCHAR2(255), CONSTRAINT PK_TB_RAWENVELOPE_LOG PRIMARY KEY (ID_PK));

CREATE TABLE TB_RECEIPT (ID_PK NUMBER(38, 0) NOT NULL, CONSTRAINT PK_TB_RECEIPT PRIMARY KEY (ID_PK));

CREATE TABLE TB_RECEIPT_DATA (RECEIPT_ID NUMBER(38, 0) NOT NULL, RAW_XML CLOB);

CREATE TABLE TB_RECEPTION_AWARENESS (ID_PK NUMBER(38, 0) NOT NULL, DUPLICATE_DETECTION NUMBER(1), NAME VARCHAR2(255), RETRY_COUNT INTEGER, RETRY_TIMEOUT INTEGER, STRATEGY VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_RECEPTION_AWARENESS PRIMARY KEY (ID_PK));

CREATE TABLE TB_RELIABILITY (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), NON_REPUDIATION NUMBER(1), REPLY_PATTERN VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_RELIABILITY PRIMARY KEY (ID_PK));

CREATE TABLE TB_REV_CHANGES (ID_PK NUMBER(38, 0) NOT NULL, REV NUMBER(38, 0), AUDIT_ORDER INTEGER, ENTIY_NAME VARCHAR2(255), GROUP_NAME VARCHAR2(255), ENTITY_ID VARCHAR2(255), MODIFICATION_TYPE VARCHAR2(255), CONSTRAINT PK_TB_REV_CHANGES PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_ROLE (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_ROLE PRIMARY KEY (ID_PK));

CREATE TABLE TB_ROUTING_CRITERIA (ID_PK NUMBER(38, 0) NOT NULL, EXPRESSION VARCHAR2(255), NAME VARCHAR2(255), FK_BACKEND_FILTER NUMBER(38, 0), PRIORITY INTEGER, CONSTRAINT PK_TB_ROUTING_CRITERIA PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_SECURITY (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), POLICY VARCHAR2(255), SIGNATURE_METHOD VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_SECURITY PRIMARY KEY (ID_PK));

CREATE TABLE TB_SEND_ATTEMPT (ID_PK NUMBER(38, 0) NOT NULL, MESSAGE_ID VARCHAR2(255) NOT NULL, START_DATE TIMESTAMP NOT NULL, END_DATE TIMESTAMP NOT NULL, STATUS VARCHAR2(255) NOT NULL, ERROR VARCHAR2(255), CONSTRAINT PK_TB_SEND_ATTEMPT PRIMARY KEY (ID_PK));

CREATE TABLE TB_SERVICE (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), SERVICE_TYPE VARCHAR2(255), VALUE VARCHAR2(255), FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_SERVICE PRIMARY KEY (ID_PK));

CREATE TABLE TB_SIGNAL_MESSAGE (ID_PK NUMBER(38, 0) NOT NULL, PULL_REQUEST_MPC VARCHAR2(255), RECEIPT_ID_PK NUMBER(38, 0), MESSAGE_ID VARCHAR2(255) NOT NULL, REF_TO_MESSAGE_ID VARCHAR2(255), TIME_STAMP TIMESTAMP, CONSTRAINT PK_TB_SIGNAL_MESSAGE PRIMARY KEY (ID_PK));

CREATE TABLE TB_SPLITTING (ID_PK NUMBER(38, 0) NOT NULL, NAME VARCHAR2(255), FRAGMENT_SIZE INTEGER, COMPRESSION NUMBER(1), COMPRESSION_ALGORITHM VARCHAR2(255), JOIN_INTERVAL INTEGER, FK_BUSINESSPROCESS NUMBER(38, 0), CONSTRAINT PK_TB_SPLITTING PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_USER_MESSAGE (ID_PK NUMBER(38, 0) NOT NULL, COLLABORATION_INFO_ACTION VARCHAR2(255), AGREEMENT_REF_PMODE VARCHAR2(255), AGREEMENT_REF_TYPE VARCHAR2(255), AGREEMENT_REF_VALUE VARCHAR2(255), COLL_INFO_CONVERS_ID VARCHAR2(255) NOT NULL, SERVICE_TYPE VARCHAR2(255), SERVICE_VALUE VARCHAR2(255), MPC VARCHAR2(255), FROM_ROLE VARCHAR2(255), TO_ROLE VARCHAR2(255), FK_MESSAGE_FRAGMENT_ID INTEGER, SPLIT_AND_JOIN NUMBER(1), MESSAGE_ID VARCHAR2(255) NOT NULL, REF_TO_MESSAGE_ID VARCHAR2(255), TIME_STAMP TIMESTAMP, CONSTRAINT PK_TB_USER_MESSAGE PRIMARY KEY (ID_PK));

CREATE TABLE TB_USER_PASSWORD_HISTORY (ID_PK NUMBER(38, 0) NOT NULL, USER_ID NUMBER(38, 0) NOT NULL, USER_PASSWORD VARCHAR2(255) NOT NULL, PASSWORD_CHANGE_DATE TIMESTAMP, CONSTRAINT PK_TB_USER_PASSWORD_HISTORY PRIMARY KEY (ID_PK));
...
CREATE TABLE TB_USER_ROLES (USER_ID NUMBER(38, 0) NOT NULL, ROLE_ID NUMBER(38, 0) NOT NULL, CONSTRAINT PK_PRIMARY PRIMARY KEY (USER_ID, ROLE_ID));
...
-- Changeset src/main/resources/db/changelog-4.2.xml::1564477107969-95::Catalin Enache
...
-- Changeset src/main/resources/db/changelog-4.2.xml::1564477107969-104::Catalin Enache
-- create indexes
...
CREATE INDEX FK_2H31P0A2Y6WEG2GRH70C9CYVA ON TB_USER_MESSAGE_PROPERTY(MESSAGE_ID);

CREATE INDEX FK_2H31P0A2Y6WEG2GRH70C9CYVAB ON TB_PART_INFO_PROPERTY(PART_INFO_ID);
...
CREATE INDEX FK_FKFTD5ORW2ETIU4GHMN3MHX9I ON TB_PARTY_ID(USER_MESSAGE_ID);
...
CREATE INDEX FK_TQ6LBN3MP0VSFC6QQU7WXY54G ON TB_PART_INFO(MESSAGE_ID);

CREATE INDEX FK_UM_MF ON TB_USER_MESSAGE(FK_MESSAGE_FRAGMENT_ID);

CREATE INDEX FK_UM_MI ON TB_USER_MESSAGE(MESSAGE_ID);
...
CREATE INDEX IDX_MESSAGE_INFO_R_T_M_ID ON TB_USER_MESSAGE(REF_TO_MESSAGE_ID);

CREATE INDEX IDX_MESSAGE_LOCK_SEARCH ON TB_MESSAGING_LOCK(MESSAGE_TYPE, MESSAGE_STATE, INITIATOR, MPC, NEXT_ATTEMPT);

CREATE INDEX IDX_MESSAGE_LOG_RECEIVED ON TB_USER_MESSAGE_LOG(RECEIVED);

CREATE INDEX IDX_MF_GRP_ID ON TB_MESSAGE_FRAGMENT(GROUP_ID);

CREATE INDEX IDX_MSG_LOG_M_STATUS_SEND_ATT ON TB_USER_MESSAGE_LOG(MESSAGE_STATUS, SEND_ATTEMPTS);

CREATE INDEX IDX_MSG_LOG_RCV_MSG_ID ON TB_USER_MESSAGE_LOG(RECEIVED, MESSAGE_ID);
...
CREATE INDEX IDX_TB_ML_MSG_ID ON TB_USER_MESSAGE_LOG(MESSAGE_ID);

CREATE INDEX IDX_UPH_USER_ID ON TB_USER_PASSWORD_HISTORY(USER_ID);

CREATE INDEX IDX_USER_ID ON TB_USER_ROLES(USER_ID);

CREATE INDEX UK_BPEFLT902YBU9NSHBA2FJPV9D ON TB_USER_MESSAGE_LOG(MSH_ROLE);

-- Changeset src/main/resources/db/changelog-4.2.xml::1564477107969-234::Catalin Enache
-- create foreign keys
...
ALTER TABLE TB_USER_MESSAGE_PROPERTY ADD CONSTRAINT FK_2H31P0A2Y6WEG2GRH70C9CYVA FOREIGN KEY (MESSAGE_ID) REFERENCES TB_USER_MESSAGE (ID_PK);

ALTER TABLE TB_PART_INFO_PROPERTY ADD CONSTRAINT FK_2H31P0A2Y6WEG2GRH70C9CYVAB FOREIGN KEY (PART_INFO_ID) REFERENCES TB_PART_INFO (ID_PK);
...
ALTER TABLE TB_PARTY_ID ADD CONSTRAINT FK_FKFTD5ORW2ETIU4GHMN3MHX9I FOREIGN KEY (USER_MESSAGE_ID) REFERENCES TB_USER_MESSAGE (ID_PK);
...
ALTER TABLE TB_PART_INFO ADD CONSTRAINT FK_TQ6LBN3MP0VSFC6QQU7WXY54G FOREIGN KEY (MESSAGE_ID) REFERENCES TB_USER_MESSAGE (ID_PK);
...
-- Changeset src/main/resources/db/changelog-4.2.xml::1564477107969-325::Catalin Enache
-- create AUDIT views
...
-- Changeset src/main/resources/db/changelog-4.2.xml::EDELIVERY-2144_1::thomas dussart
...
-- Update Database Script
-- *********************************************************************
-- Change Log: src/main/resources/db/changelog-4.2-data.xml
-- Ran at: 2/18/20 5:04 PM
-- Against: null@offline:oracle?version=11.2.0&changeLogFile=C:\Users\dussa\IdeaProjects\secondDomibus\Domibus-MSH-db\target/liquibase/changelog-4.2-data.oracle
-- Liquibase version: 3.5.3
-- *********************************************************************

-- Changeset src/main/resources/db/changelog-4.2-data.xml::EDELIVERY-2144::thomas dussart
-- inserts
...
-- Changeset src/main/resources/db/changelog-4.2-data.xml::insert_ws_default_auth::idragusa
