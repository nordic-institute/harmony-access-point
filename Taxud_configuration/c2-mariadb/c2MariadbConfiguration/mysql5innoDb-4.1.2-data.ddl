...
--  *********************************************************************
--  Change Log: src/main/resources/db/changelog-4.1.2-data.xml
--  Ran at: 26/09/19, 14:31
--  Against: null@offline:mysql?changeLogFile=C:\Users\dussa\IdeaProjects\domibus\Domibus-MSH-db\target/liquibase/changelog-4.1.2-data.mysql
--  Liquibase version: 3.5.3
--  *********************************************************************

--  Changeset src/main/resources/db/changelog-4.1.2-data.xml::EDELIVERY-2144::thomas dussart
--  inserts
...
--  Changeset src/main/resources/db/changelog-4.1.2-data.xml::insert_ws_default_auth::idragusa
