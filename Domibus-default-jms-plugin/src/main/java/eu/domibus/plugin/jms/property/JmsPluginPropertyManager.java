...
public class JmsPluginPropertyManager extends DomibusPropertyExtServiceDelegateAbstract {
    ...
    public Map<String, DomibusPropertyMetadataDTO> getKnownProperties() {
        ...
        List<DomibusPropertyMetadataDTO> readOnlyGlobalProperties = Arrays.stream(new String[]{
                QUEUE_NOTIFICATION,
                QUEUE_IN,
        ...
        List<DomibusPropertyMetadataDTO> readOnlyDomainProperties = Arrays.stream(new String[]{
                JMSPLUGIN_QUEUE_OUT,
        ...
        List<DomibusPropertyMetadataDTO> writableProperties = Arrays.stream(new String[]{
