...
public class JsonSubmission {
    ...
    /**
     * Returns a {@link Set} of {@link JsonSubmission.Party} elements representing the fromParties
     * of this plugin. A fromParty contains information describing the originating party.
     *
     * @return a {@link Set} of {@link JsonSubmission.Party} elements containing information describing the originating party
     */
     ...
     * (OASIS ebXML Messaging Services Version 3.0: Part 1, Core Features, 1 October 2007)
     *
     * @return an object of type {@link Properties} representing the message properties of this plugin
     */
    ...
    /**
     * Returns a {@link Set} of {@link JsonSubmission.Party} elements representing the toParties
     * of this plugin. A toParty contains information describing the destination party.
     *
     * @return a {@link Set} of {@link JsonSubmission.Party} elements containing information describing the destination party.
     */
    ...
    /**
     * Returns a {@link Set} of {@link JsonSubmission.Payload} elements representing the payloads
     * of this plugin. A {@link JsonSubmission.Payload} contains information describing the payload and the payload itself.
     *
     * @return a {@link Set} of {@link JsonSubmission.Payload} elements representing the payloads of this plugin
     */
    ...
    /**
     * This method adds one payload to the {@link Set} of {@link JsonSubmission.Payload} elements.
    ...
    /**
     * This method adds one payload to the {@link Set} of {@link JsonSubmission.Payload} elements.
     * In this case the parameter contentId, a {@link Set} of payload properties and the payload data itself were set.
     ...
     * @param contentId          a string that is the [RFC2392] Content-ID URI of the payload object referenced
     * @param payloadDatahandler a DataHandler array with the payload data
     * @param payloadProperties  a {@link Properties} object representing the properties of this payload
     */
    ...
    public void addPayload(final String contentId, final DataHandler payloadDatahandler, final Collection<TypedProperty> payloadProperties, final boolean inBody, final Description description, final String schemaLocation) {
        this.payloads.add(new JsonSubmission.Payload(contentId, payloadDatahandler, payloadProperties, inBody, description, schemaLocation));
    }

    /**
     * This method adds one originating party to the {@link Set} of {@link JsonSubmission.Party} elements.
     * <p/>
     * Paramters are:
     * <ol>
    ...
    public void addFromParty(final String partyId, final String partyIdType) {
        this.fromParties.add(new JsonSubmission.Party(partyId, partyIdType));
    }

    /**
     * This method adds one destination party to the {@link Set} of {@link JsonSubmission.Party} elements.
     * <p/>
     * Paramters are:
     * <ol>
    ...
    public static class Party {
        ...
        public boolean equals(final Object o) {
            ...
            if (!(o instanceof JsonSubmission.Party)) return false;

            final JsonSubmission.Party party = (JsonSubmission.Party) o;
    ...
    public static class Payload {
        ...
        public boolean equals(final Object o) {
            if (this == o) return true;
            if (!(o instanceof JsonSubmission.Payload)) return false;

            final JsonSubmission.Payload payload = (JsonSubmission.Payload) o;
