...
public interface DomibusPropertyMetadataManager {
    ...
    String DOMIBUS_ALERT_USER_ACCOUNT_ENABLED_MOMENT = DOMIBUS_ALERT_USER_ACCOUNT_ENABLED_PREFIX + "moment";
    ...
    String DOMIBUS_ALERT_PLUGIN_USER_ACCOUNT_ENABLED_MOMENT = DOMIBUS_ALERT_PLUGIN_USER_ACCOUNT_ENABLED_PREFIX + "moment";
