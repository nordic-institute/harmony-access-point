...
@NamedQueries({
        @NamedQuery(name = "TimezoneOffset.findByTimezoneIdAndOffsetSeconds", query = "select t from TimezoneOffset t where t.nextAttemptTimezoneId = :TIMEZONE_ID and t.nextAttemptOffsetSeconds = :OFFSET_SECONDS")
})
