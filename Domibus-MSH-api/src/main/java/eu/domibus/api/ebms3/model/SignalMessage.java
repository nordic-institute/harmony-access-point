...
public class SignalMessage {
    ...
    protected eu.domibus.api.ebms3.model.MessageInfo messageInfo;

    @XmlElement(name = "PullRequest")
    protected eu.domibus.api.ebms3.model.PullRequest pullRequest; //NOSONAR

    @XmlElement(name = "Receipt")
    protected eu.domibus.api.ebms3.model.Receipt receipt;
     ...
     *
     * @return possible object is {@link eu.domibus.api.ebms3.model.MessageInfo }
     */
    public eu.domibus.api.ebms3.model.MessageInfo getMessageInfo() {
     ...
     *
     * @param value allowed object is {@link eu.domibus.api.ebms3.model.MessageInfo }
     */
     ...
     *
     * @return possible object is {@link eu.domibus.api.ebms3.model.PullRequest }
     */
    public eu.domibus.api.ebms3.model.PullRequest getPullRequest() {
     ...
     * be pulled. The absence of this attribute indicates the default MPC.
     *
     * @param value allowed object is {@link eu.domibus.api.ebms3.model.PullRequest }
     */
     ...
     * receipt.
     *
     * @return possible object is {@link eu.domibus.api.ebms3.model.Receipt }
     */
    public eu.domibus.api.ebms3.model.Receipt getReceipt() {
        return this.receipt;
    }
     ...
     * receipt.
     *
     * @param value allowed object is {@link eu.domibus.api.ebms3.model.Receipt }
     */
     ...
     *
     * @see eu.domibus.api.ebms3.model.Error
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link eu.domibus.api.ebms3.model.Error }
     *
