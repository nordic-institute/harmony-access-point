...
public enum DomibusMessageCode implements MessageCode {
    ...
    MESSAGE_HEADER_MISSING("BUS-078", "Mandatory Message Headers are not provided"),
    BUS_FROM_PARTYID_NOT_SPECIFIED("BUS-079", "Mandatory field From PartyId is not provided"),
    BUS_FROM_PARTYID_TOO_LONG("BUS-080", "From PartyId is too long (over 255 characters)."),
    BUS_FROM_PARTYIDTYPE_NOT_SPECIFIED("BUS-081", "Mandatory field From PartyIdType is not provided"),
    BUS_FROM_PARTYIDTYPE_TOO_LONG("BUS-082", "From PartyIdType is too long (over 255 characters)."),
    BUS_FROM_ROLE_NOT_SPECIFIED("BUS-083", "Mandatory field From Role is not provided"),
    BUS_FROM_ROLE_TOO_LONG("BUS-084", "From Role is too long (over 255 characters)."),
    BUS_TO_PARTYID_NOT_SPECIFIED("BUS-085", "Mandatory field To PartyId is not provided"),
    BUS_TO_PARTYID_TOO_LONG("BUS-086", "To PartyId is too long (over 255 characters)."),
    BUS_TO_PARTYIDTYPE_NOT_SPECIFIED("BUS-087", "Mandatory field To PartyIdType is not provided"),
    BUS_TO_PARTYIDTYPE_TOO_LONG("BUS-088", "To PartyIdType is too long (over 255 characters)."),
    BUS_TO_ROLE_NOT_SPECIFIED("BUS-089", "Mandatory field To Role is not provided"),
    BUS_TO_ROLE_TOO_LONG("BUS-090", "To Role is too long (over 255 characters)."),
    BUS_AGREEMENT_REF_VALUE_TOO_LONG("BUS-091", "AgreementRef Value is too long (over 255 characters)."),
    BUS_AGREEMENT_REF_TYPE_TOO_LONG("BUS-092", "AgreementRef Type is too long (over 255 characters)."),
    BUS_AGREEMENT_REF_PMODE_TOO_LONG("BUS-093", "AgreementRef PMode is too long (over 255 characters)."),
    BUS_SERVICE_NOT_SPECIFIED("BUS-094", "Mandatory field Service is not provided"),
    BUS_SERVICE_TOO_LONG("BUS-095", "Service is too long (over 255 characters)."),
    BUS_SERVICE_TYPE_NOT_SPECIFIED("BUS-096", "Mandatory field From ServiceType is not provided"),
    BUS_SERVICE_TYPE_TOO_LONG("BUS-097", "ServiceType is too long (over 255 characters)."),
    BUS_ACTION_NOT_SPECIFIED("BUS-098", "Mandatory field Action is not provided"),
    BUS_ACTION_TOO_LONG("BUS-099", "Action is too long (over 255 characters)."),
