...
public enum DomibusMessageCode implements MessageCode {
    ...
    BUS_ARCHIVE_BATCH_NOTIFICATION_SENT("BUS-086", "• Notification for batch [{}] is sent from Domibus to the archiving client!"),
    BUS_ARCHIVE_BATCH_NOTIFICATION_RECEIVED("BUS-087", "• Notification for batch: [{}] with status: [{}] and message: [{}] received from the archiving client to Domibus!"),
