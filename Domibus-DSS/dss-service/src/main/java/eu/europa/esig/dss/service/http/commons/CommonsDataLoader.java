...
public class CommonsDataLoader implements DataLoader {
	...
	private static final Logger LOG = LoggerFactory.getLogger(eu.europa.esig.dss.service.http.commons.CommonsDataLoader.class);
	 ...
	 */
	public eu.europa.esig.dss.service.http.commons.CommonsDataLoader addAuthentication(final String host, final int port, final String scheme,
	 ...
	 */
	public void propagateAuthentication(final eu.europa.esig.dss.service.http.commons.CommonsDataLoader commonsDataLoader) {
