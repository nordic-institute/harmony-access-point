...
public class ResourceLoader {
	...
	protected Class<?> anyClass = eu.europa.esig.dss.service.http.commons.ResourceLoader.class;

	/**
	 * Empty constructor. Loads path relatively to the {@link eu.europa.esig.dss.service.http.commons.ResourceLoader} class directory.
	 */
