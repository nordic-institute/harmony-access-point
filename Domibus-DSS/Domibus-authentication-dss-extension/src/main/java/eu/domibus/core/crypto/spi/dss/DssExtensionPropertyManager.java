...
public class DssExtensionPropertyManager extends DomibusPropertyExtServiceDelegateAbstract implements DomibusPropertyManagerExt {
    ...
    public static final String DSS_USE_EXPIRATION_AND_SIGNATURE_CHECK_STRATEGY = "domibus.dss.use.expiration.and.signature.check.strategy";
    ...
    public DssExtensionPropertyManager() {
        List<DomibusPropertyMetadataDTO> allProperties = Arrays.asList(
                ...
                new DomibusPropertyMetadataDTO(DSS_USE_EXPIRATION_AND_SIGNATURE_CHECK_STRATEGY, DomibusPropertyMetadataDTO.Type.BOOLEAN, Module.DSS, DomibusPropertyMetadataDTO.Usage.GLOBAL),
