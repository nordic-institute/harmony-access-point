...
public enum DomibusMessageCode implements MessageCode {
    ...
    BUS_MESSAGE_RECEIVED("BUS-001", "Message received [SUCCESS] [{}] from [{}] to [{}]"),
    BUS_MESSAGE_RECEIVE_FAILED("BUS-002", "Message received [FAIL] from [{}] to [{}]"),
    ...
    BUS_MESSAGE_SEND_SUCCESS("BUS-033", "Message sent [SUCCESS] [{}] from [{}] to [{}]"),
    BUS_MESSAGE_SEND_FAILURE("BUS-034", "Message sent [FAIL] [{}] from [{}] to [{}]"),
    ...
    BUS_MESSAGE_RECEIPT_GENERATED("BUS-046", "Message receipt generated [SUCCESS] with nonRepudiation value [{}]"),
    BUS_MESSAGE_RECEIPT_FAILURE("BUS-047", "Message receipt generated [FAIL]"),
    ...
    BUS_MESSAGE_SUBMITTED("BUS-064", "Message submitted [SUCCESS] from [{}] to [{}]"),
    BUS_MESSAGE_SUBMIT_FAILED("BUS-065", "Message submitted [FAIL] from [{}] to [{}]"),
    BUS_MESSAGE_RETRIEVED("BUS-066", "Message retrieved [SUCCESS]"),
    BUS_MESSAGE_RETRIEVE_FAILED("BUS-067", "Message retrieved [FAIL]"),
    ...
    BUS_TEST_MESSAGE_SEND_SUCCESS("BUS-071", "Test message sent [SUCCESS] [{}] from [{}] to [{}]"),
    BUS_TEST_MESSAGE_SEND_FAILURE("BUS-072", "Test message sent [FAIL] [{}] from [{}] to [{}]"),
    ...
    BUS_ARCHIVE_BATCH_EXPORTED("BUS-085", "Batch [{}] exported [SUCCESS] to file path: {}!"),
    ...
    BUS_ARCHIVE_BATCH_EXPORT_FAILED("BUS-089", "Batch [{}] exported [FAIL]. Error message: [{}]!"),
    ...
    BUS_MESSAGE_PLUGIN_RECEIVE_FAILED("BUS-094", "[FAIL] to receive message in the plugin [{}]"),
    ...
    BUS_MSG_RECEIVED_FROM_JMS_IN_QUEUE("BUS-099", "Message received [SUCCESS] from JMS Plugin inQueue: Message with id [{}], conversationId [{}] and jmsCorrelationID [{}]."),
    BUS_MSG_DELIVERED_TO_JMS_OUT_QUEUE("BUS-100", "Message delivered [SUCCESS] to JMS Plugin outQueue: Message with id [{}], entityId [{}] and conversationId [{}]."),
    BUS_MSG_RETRY("BUS-101", "Scheduling send retry {}/{} for message with id [{}]."),
    //102 available
    BUS_MSG_DELIVERED_TO_JMS_OUT_QUEUE_FAILED("BUS-103", "Message delivered [FAIL] to JMS Plugin outQueue"),
    BUS_MSG_RECEIVED_FROM_JMS_IN_QUEUE_FAILED("BUS-104", "Message received [FAIL] from JMS Plugin inQueue"),
    BUS_MESSAGE_RETRY_MESSAGE_ATTEMPT("BUS-105", "Message sending [FAIL] on attempt [{}]/[{}] from [{}] to [{}]"),
    BUS_MESSAGE_STATUS_INITIAL("BUS-106", "Message with type [{}] persisted with initial status [{}]"),
    BUS_MESSAGE_RECEIPT_RECEIVED_SUCCESS("BUS-107", "Message receipt received [SUCCESS] [{}]"),
    BUS_MESSAGE_RECEIPT_RECEIVED_FAILED("BUS-108", "Message receipt received [FAIL] [{}]"),
    BUS_MESSAGE_PULL_REQUEST_RECEIVED_SUCCESS("BUS-109", "Pull request received [SUCCESS]"),
    BUS_MESSAGE_PULL_REQUEST_RECEIVED_FAILED("BUS-110", "Pull request received [FAIL]"),
    BUS_MESSAGE_RESTORED_SUCCESS("BUS-111", "Message restored [SUCCESS]"),
    BUS_MESSAGE_RESTORED_FAILED("BUS-112", "Message restored [FAIL]"),
