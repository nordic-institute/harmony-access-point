...
public enum DomibusMessageCode implements MessageCode {
    ...
    BUS_MESSAGE_RECEIVED("BUS-001", "Message received [SUCCESS] from [{}] to [{}] at [{}]"),
    BUS_MESSAGE_RECEIVE_FAILED("BUS-002", "Message received [FAILED] from [{}] to [{}]"),
    ...
    BUS_MESSAGE_SEND_FAILURE("BUS-034", "Message sent [FAILED] from [{}] to [{}]"),
    ...
    BUS_MESSAGE_RECEIPT_FAILURE("BUS-047", "Message receipt generated [FAILED]"),
    ...
    BUS_MESSAGE_SUBMIT_FAILED("BUS-065", "Message submitted [FAILED] from [{}] to [{}]"),
    BUS_MESSAGE_RETRIEVED("BUS-066", "Message retrieved [SUCCESS]"),
    BUS_MESSAGE_RETRIEVE_FAILED("BUS-067", "Message retrieved [FAILED]"),
    ...
    BUS_TEST_MESSAGE_SEND_FAILURE("BUS-072", "Test message sent [FAILED]"),
    ...
    BUS_ARCHIVE_BATCH_EXPORT_FAILED("BUS-089", "Batch [{}] exported [FAILED]. Error message: [{}]!"),
