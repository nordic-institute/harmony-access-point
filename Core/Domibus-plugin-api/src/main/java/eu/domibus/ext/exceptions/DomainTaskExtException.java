...
/**
 * Raised in case an exception occurs when executing tasks.
 *
 * @author Cosmin Baciu
 * @since 4.1
 */
public class DomainTaskExtException extends DomibusServiceExtException {
     ...
     */
    public DomainTaskExtException(DomibusErrorCode errorCode, String message) {
     ...
     */
    public DomainTaskExtException(Throwable cause) {
     ...
     * @param cause     the cause of the exception.
     */
    public DomainTaskExtException(DomibusErrorCode errorCode, String message, Throwable cause) {
     ...
     * @param cause   the cause of the exception.
     */
    public DomainTaskExtException(String message, Throwable cause) {
