-- ********************************************************************************************************
-- Domibus 5.0.2 to 5.0.2 ongoing messages data migration package
--
...
CREATE OR REPLACE PACKAGE MIGRATE_ONGOING_MESSAGES_502 IS
...
END MIGRATE_ONGOING_MESSAGES_502;
/

CREATE OR REPLACE PACKAGE BODY MIGRATE_ONGOING_MESSAGES_502 IS
...
--
-- Uncomment trailing line to execute the MIGRATE_ONGOING_MESSAGES_502.MIGRATE(..) procedure and to clean up the temporary tables
