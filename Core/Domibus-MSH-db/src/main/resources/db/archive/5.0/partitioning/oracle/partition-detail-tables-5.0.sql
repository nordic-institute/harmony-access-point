...
ALTER TABLE TB_SEND_ATTEMPT
    MODIFY PARTITION BY REFERENCE ( FK_SEND_ATTEMPT_USER_MSG );

ALTER TABLE TB_ERROR_LOG
    MODIFY PARTITION BY REFERENCE ( FK_ERROR_LOG_MSG_ID )
UPDATE INDEXES ( IDX_ERROR_LOG_MSH_ROLE_ID LOCAL, IDX_MESSAGE_IN_ERROR_ID LOCAL, IDX_SIGNAL_MESSAGE_ID LOCAL );
