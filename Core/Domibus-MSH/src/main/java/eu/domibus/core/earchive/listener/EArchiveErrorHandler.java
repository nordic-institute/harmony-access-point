...
public class EArchiveErrorHandler implements ErrorHandler {
    ...
    private final DomibusStringImplUtil domibusStringImplUtil;

    public EArchiveErrorHandler(EArchivingDefaultService eArchivingDefaultService, DomibusStringImplUtil domibusStringImplUtil) {
        this.eArchivingDefaultService = eArchivingDefaultService;
        this.domibusStringImplUtil = domibusStringImplUtil;
    }
    ...
    public void handleError(Throwable t) {
        ...
        eArchivingDefaultService.setStatus(eArchiveBatchByBatchId, EArchiveBatchStatus.FAILED, StringUtils.substring(t.getMessage(), 0, domibusStringImplUtil.DEFAULT_MAX_STRING_LENGTH - 1), DomibusMessageCode.BUS_ARCHIVE_BATCH_EXPORT_FAILED.getCode());
