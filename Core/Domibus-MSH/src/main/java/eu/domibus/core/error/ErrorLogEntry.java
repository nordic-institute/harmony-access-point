...
@NamedQuery(name = "ErrorLogEntry.findErrorsByMessageIdAndRole", query = "select e from ErrorLogEntry e where e.messageInErrorId = :MESSAGE_ID and e.mshRole.role = :MSH_ROLE order by e.timestamp desc")
