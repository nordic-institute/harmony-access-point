...
public class PluginPayloadProcessedNotifier implements PluginEventNotifier<PayloadProcessedEvent> {
    ...
    @Override
    public void notifyPlugin(PayloadProcessedEvent messageEvent, BackendConnector<?, ?> backendConnector, Long messageEntityId, String messageId, Map<String, String> properties) {
