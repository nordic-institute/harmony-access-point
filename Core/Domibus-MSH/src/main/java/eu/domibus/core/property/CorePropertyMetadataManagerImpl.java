...
public class CorePropertyMetadataManagerImpl implements DomibusPropertyMetadataManagerSPI {
    ...
    private Map<String, DomibusPropertyMetadata> knownProperties = Arrays.stream(new DomibusPropertyMetadata[]{
            ...
            DomibusPropertyMetadata.getReadOnlyGlobalProperty(DOMIBUS_UI_SESSION_DATABASE_UNIQUE_NAME, Type.BOOLEAN),
            ...
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_CLIENT_DNS_LOOKUP_TYPES, Type.COMMA_SEPARATED_LIST, Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_DYNAMICDISCOVERY_CLIENT_WILDCARD_DOCUMENT_SCHEMES, Type.COMMA_SEPARATED_LIST, Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_DOWNLOAD_CACERTS_ENABLED, Type.BOOLEAN, Usage.DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_FILE_UPLOAD_MAX_SIZE, Type.NUMERIC, Usage.GLOBAL_AND_DOMAIN, true),
            ...
            new DomibusPropertyMetadata(DOMIBUS_QUARTZ_JOB_STORE_MISFIRED_THRESHOLD, Type.NUMERIC, Usage.DOMAIN, true),
            new DomibusPropertyMetadata(DOMIBUS_QUARTZ_JOB_STORE_ACQUIRE_TRIGGER_WITHIN_LOCK, Type.BOOLEAN, Usage.DOMAIN, true),
