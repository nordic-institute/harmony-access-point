...
public enum EventType {
    ...
    ARCHIVING_MESSAGE_EXPORT_FAILED(AlertType.ARCHIVING_MESSAGE_EXPORT_FAILED, Arrays.asList("BATCH_ID", "MESSAGE_ID", "REASON")),

    PARTITION_CHECK(AlertType.PARTITION_CHECK, Arrays.asList("PARTITION_NAME")),

    OLD_ONGOING_MESSAGES(AlertType.OLD_ONGOING_MESSAGES, Arrays.asList("MESSAGES_COUNT", "THRESHOLD_DATE")),

    CONNECTION_MONITORING_FAILED(AlertType.CONNECTION_MONITORING_FAILED, Arrays.asList("MESSAGE_ID", "ROLE", "OLD_STATUS", "NEW_STATUS", "FROM_PARTY", "TO_PARTY"));
