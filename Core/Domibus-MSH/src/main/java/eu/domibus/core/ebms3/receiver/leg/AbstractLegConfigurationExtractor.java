...
public abstract class AbstractLegConfigurationExtractor implements LegConfigurationExtractor {
    ...
    private static final IDomibusLogger LOG = DomibusLoggerFactory.getLogger(AbstractLegConfigurationExtractor.class);
    ...
    public void setUpMessage(final String pmodeKey) {
        ...
        LOG.putMDC(IDomibusLogger.MDC_MESSAGE_ID, getMessageId());
