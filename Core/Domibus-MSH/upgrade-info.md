                ...
                - Custom 4.2.x plugins are no longer compatible with Domibus 5.0 and must be adapted to use the new plugin api. For more details please check the Plugin Cookbook.
                  The following API has been removed:
                    ...
                    o methods: eu.domibus.plugin.BackendConnector.listPendingMessages(), eu.domibus.plugin.AbstractBackendConnector.listPendingMessages()
                               ...
                               eu.domibus.ext.services.DomibusPropertyManagerExt.setKnownPropertyValue(java.lang.String, java.lang.String, java.lang.String), eu.domibus.common.MessageReceivedEvent.setFinalRecipient(java.lang.String),
                               eu.domibus.common.MessageReceivedEvent.getFinalRecipient(java.lang.String), eu.domibus.common.MessageReceivedEvent.getProperties(), eu.domibus.common.MessageDeletedBatchEvent.getMessageIds,
