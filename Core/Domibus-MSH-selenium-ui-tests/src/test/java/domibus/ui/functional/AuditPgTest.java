...
public class AuditPgTest extends SeleniumTest {
    ...
    /* EDELIVERY-9633 - AU-55 - Create/Edit/Delete Super users is visible in Audot page separate from domain events */
    ...
    public void superUserSuperAudit() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i < 2) {
                ...
                soft.assertEquals(info.get(i).get("Action"), "Deleted", "Deleted action is present in audit log");
            }
        }
