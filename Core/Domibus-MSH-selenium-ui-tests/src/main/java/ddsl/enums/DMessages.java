...
public class DMessages {
	...
	public static final String CONNECTION_MONITORING_ERROR_RESPONDER_NOTUP = "Error retrieving the response signal for %s. Error details: EBMS:0005-Error dispatching message to %s";
	public static final String CONNECTION_MONITORING_ERROR = "Error retrieving the response signal for %s.Please call the method again to see the details.";
	public static final String CONNECTION_MONITORING_CERT_ERROR = "Error retrieving the response signal for %s. Error details: EBMS:0004-[DOM_001]:Cannot send message: receiver certificate is not valid or it has been revoked [%s]";
