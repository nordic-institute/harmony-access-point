...
zap.replacer.add_rule(description="authh", enabled=True, matchtype="REQ_HEADER", matchregex=False,
                      matchstring="Authorization", replacement=plugin_auth_info, initiators=2, apikey=apiKey)
