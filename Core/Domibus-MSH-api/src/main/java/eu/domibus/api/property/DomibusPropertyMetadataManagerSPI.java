...
public interface DomibusPropertyMetadataManagerSPI {
    ...
    //RSA Encrypt
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_MINIMUM_LENGTH_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "minimumLength.rsa.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_SUITE_TYPE_KEY_EXCHANGE_TYPE_RSA_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithmSuiteTypeKeyExchangeType.rsa.encrypt";
    ...
    //ECC Encrypt
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_MINIMUM_LENGTH_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "minimumLength.ecc.encrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_SUITE_TYPE_KEY_EXCHANGE_TYPE_ECC_ENCRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithmSuiteTypeKeyExchangeType.ecc.encrypt";
