...
public interface DomibusPropertyMetadataManagerSPI {
    ...
    //RSA Sign
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.rsa.sign";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.rsa.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.rsa.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.rsa.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.rsa.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_RSA_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.rsa.sign";
    //RSA Encrypt
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.rsa.decrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_MINIMUM_LENGTH_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "minimumLength.rsa.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_SUITE_TYPE_KEY_EXCHANGE_TYPE_RSA_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithmSuiteTypeKeyExchangeType.rsa.decrypt";

    //ECC Sign
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.ecc.sign";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.ecc.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.ecc.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.ecc.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.ecc.sign";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_ECC_SIGN = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.ecc.sign";
    //ECC Encrypt
    String DOMIBUS_SECURITY_KEY_PRIVATE_ALIAS_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "alias.ecc.decrypt";
    String DOMIBUS_SECURITY_KEY_PRIVATE_PASSWORD_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "password.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_TYPE_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateType.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_CERTIFICATE_KEY_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "certificateKey.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_HASH_FUNCTION_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "hashFunction.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithm.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_MINIMUM_LENGTH_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "minimumLength.ecc.decrypt";
//    String DOMIBUS_SECURITY_KEY_PRIVATE_ALGORITHM_SUITE_TYPE_KEY_EXCHANGE_TYPE_ECC_DECRYPT = DOMIBUS_SECURITY_KEY_PRIVATE_PREFIX + "algorithmSuiteTypeKeyExchangeType.ecc.decrypt";
