...
@NamedQueries({
        ...
        @NamedQuery(name = "SignalMessageLog.findByMessageIdAndRole", query = "select signalMessageLog from SignalMessageLog signalMessageLog where signalMessageLog.signalMessage.signalMessageId=:MESSAGE_ID " +
                "and signalMessageLog.mshRole.entityId=:MSH_ROLE_ID"),
