...
/**
 * Copy-Paste of org.hibernate.id.enhanced.TableGenerator class because it was impossible to fix the line 679: getting the correct tenant/domain
 *
 * @author Ion Perpegel
 * @since 5.1.4
 */
 ...
 */
public class DomibusTableGenerator implements PersistentIdentifierGenerator {
	private static final CoreMessageLogger LOG = Logger.getMessageLogger(
			CoreMessageLogger.class,
			DomibusTableGenerator.class.getName()
	);
		...
		return optimizer.generate(
				new AccessCallback() {
					...
					public String getTenantIdentifier() {
						return getCurrentDomain(session);
					}
				}
		);
	}
