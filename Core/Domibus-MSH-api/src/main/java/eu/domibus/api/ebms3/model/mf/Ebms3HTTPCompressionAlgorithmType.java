...
@XmlEnum
public enum Ebms3HTTPCompressionAlgorithmType {
    ...
    Ebms3HTTPCompressionAlgorithmType(String v) {
        value = v;
    }
    ...
    public static Ebms3HTTPCompressionAlgorithmType fromValue(String v) {
        for (Ebms3HTTPCompressionAlgorithmType c : Ebms3HTTPCompressionAlgorithmType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
