...
public class Ebms3From {
    ...
    @XmlElement(name = "Role", required = true, defaultValue = Ebms3From.DEFAULT_ROLE)
     ...
     *
     * @return a reference to the live list of party ids
     */
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof Ebms3From)) return false;

        final Ebms3From ebms3From = (Ebms3From) o;

        if (!this.partyId.equals(ebms3From.getPartyId())) return false;
        return !(this.role != null ? !this.role.equalsIgnoreCase(ebms3From.role) : ebms3From.role != null);
