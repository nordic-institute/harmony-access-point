...
@NamedQueries({
        ...
        @NamedQuery(name = "UserMessageLog.getMessageStatus2", query = "select userMessageLog.messageStatus from UserMessageLog userMessageLog where userMessageLog.userMessage.messageId=:MESSAGE_ID and userMessageLog.mshRole.role=:MSH_ROLE"),
        ...
        @NamedQuery(name = "UserMessageLog.findBackendForMessage2", query = "select userMessageLog.backend from UserMessageLog userMessageLog where userMessageLog.userMessage.messageId=:MESSAGE_ID and userMessageLog.mshRole.role=:MSH_ROLE"),
