...
@NamedQueries({
        ...
        @NamedQuery(name = "UserMessageLog.findByUserMessageEntityId", query = "select userMessageLog from UserMessageLog userMessageLog where userMessageLog.userMessage.entityId=:MESSAGE_ENTITY_ID"),
        @NamedQuery(name = "UserMessageLog.findByUserMessageEntityIdAndRole", query = "select userMessageLog from UserMessageLog userMessageLog where userMessageLog.userMessage.entityId=:MESSAGE_ENTITY_ID and userMessageLog.mshRole.role=:MSH_ROLE"),
