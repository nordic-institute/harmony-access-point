...
/**
 * Test specific broker factory bean required to allow broker plugin registration needed in the tests.
 *
 * It delays automatic startup of the broker until the factory object is created. When creating the factory object, it
 * registers any existing broker plugins and then manually starts the broker.
 * broker.
 *
