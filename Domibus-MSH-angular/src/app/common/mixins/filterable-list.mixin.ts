...
let FilterableListMixin = (superclass: Constructable) => class extends superclass
    ...
    protected createAndSetParameters()
        :
        HttpParams {
    ...
    protected async canProceedToFilter()
        :
        Promise<boolean> {
 ...
 */
export let
    ClientFilterableListMixin = (superclass: Constructable) => class extends FilterableListMixin(superclass) {
        constructor(...args) {
            super(...args);
 ...
 */
export let
    ServerFilterableListMixin = (superclass: Constructable) => class extends FilterableListMixin(superclass) {
        constructor(...args) {
            super(...args);
            super.type = PaginationType.Client;
        }
