...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    def cleanDatabaseForDomains(domainIdList) {
        ...
        def sqlQueriesList = [
				...
				"delete from TB_ERROR_LOG where USER_MESSAGE_ID_FK NOT IN (19700101)",
...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    def cleanDBMessageIDForDomains(String messageID, domainIdList, boolean  messgaeIDStartWithProvidedValue = false) {
        ...
        def sqlQueriesList = [
				...
				"delete from TB_ERROR_LOG where ((USER_MESSAGE_ID_FK IN (" + select_ID_PK + ")) OR (MESSAGE_IN_ERROR_ID "+messageIDCheck+")) AND (USER_MESSAGE_ID_FK NOT IN (19700101))",
