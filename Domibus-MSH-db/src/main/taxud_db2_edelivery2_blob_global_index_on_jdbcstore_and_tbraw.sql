...
-- CREATE TABLE TB_RAWENVELOPE_LOG (ID_PK NUMBER(38, 0) NOT NULL, USERMESSAGE_ID_FK NUMBER(38, 0), SIGNALMESSAGE_ID_FK NUMBER(38, 0), RAW_XML BLOB, MESSAGE_ID VARCHAR2(255), CREATION_TIME TIMESTAMP DEFAULT sysdate NOT NULL, CREATED_BY VARCHAR2(255) DEFAULT user NOT NULL, MODIFICATION_TIME TIMESTAMP, MODIFIED_BY VARCHAR2(255), CONSTRAINT PK_TB_RAWENVELOPE_LOG PRIMARY KEY (ID_PK));

CREATE TABLE tb_rawenvelope_log (
    id_pk                 NUMBER(38, 0) NOT NULL,
    usermessage_id_fk     NUMBER(38, 0),
    signalmessage_id_fk   NUMBER(38, 0),
    raw_xml               BLOB,
    message_id            VARCHAR2(255),
    creation_time         TIMESTAMP DEFAULT sysdate NOT NULL,
    created_by            VARCHAR2(255) DEFAULT user NOT NULL,
    modification_time     TIMESTAMP,
    modified_by           VARCHAR2(255),
    PRIMARY KEY ( id_pk ) USING INDEX GLOBAL PARTITION BY HASH (id_pk) PARTITIONS 8 
)LOB (raw_xml) STORE AS SECUREFILE (ENABLE STORAGE IN ROW); 
