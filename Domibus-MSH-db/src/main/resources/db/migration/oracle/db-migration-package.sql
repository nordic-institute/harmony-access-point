...
CREATE OR REPLACE PACKAGE BODY MIGRATE_42_TO_50 IS
    ...
    BEGIN
        ...
        v_sql :=
                'CREATE TABLE MIGR_TB_SJ_MESSAGE_HEADER (ID_PK NUMBER(38, 0) NOT NULL, BOUNDARY VARCHAR2(255), START_MULTIPART VARCHAR2(255), CREATION_TIME TIMESTAMP DEFAULT sysdate NOT NULL, CREATED_BY VARCHAR2(255) DEFAULT user NOT NULL, MODIFICATION_TIME TIMESTAMP, MODIFIED_BY VARCHAR2(255), CONSTRAINT PK_SJ_MESSAGE_HEADER PRIMARY KEY (ID_PK))';
        create_table(v_table, v_sql);
