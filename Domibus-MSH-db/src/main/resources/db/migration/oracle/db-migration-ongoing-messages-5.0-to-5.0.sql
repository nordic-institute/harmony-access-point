...
CREATE OR REPLACE PACKAGE BODY MIGRATE_ONGOING_MESSAGES IS
    ...
    FUNCTION migrate_tb_d_party(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
        CURSOR c_d_party IS
    ...
    FUNCTION migrate_tb_d_mpc(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
        CURSOR c_d_mpc IS
    ...
    FUNCTION migrate_tb_d_role(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
        CURSOR c_d_role IS
    ...
    FUNCTION migrate_tb_d_service(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_agreement(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_action(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_msh_role(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_timezone_offset(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_notification_status(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    FUNCTION migrate_tb_d_message_property(db_link IN VARCHAR2) RETURN T_LOCAL_TO_REMOTE_PRIMARY_KEYS IS
    ...
    PROCEDURE migrate_user_message(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, action_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, agreement_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, service_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, mpc_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, party_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, role_lookup_table IN T_LOCAL_TO_REMOTE_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_signal_message(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_signal_message_log(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, message_status_lookup_table T_LOCAL_TO_REMOTE_PRIMARY_KEYS, msh_role_lookup_table T_LOCAL_TO_REMOTE_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        ...
        LOOP
            ...
            FOR i IN signal_message_log.FIRST .. signal_message_log.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_SIGNAL_MESSAGE_LOG@' || db_link || ' (ID_PK, RECEIVED, DELETED, MESSAGE_STATUS_ID_FK, MSH_ROLE_ID_FK, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4, :p_5, :p_6, :p_7)'
                        ...
                        lookup_value_safely(message_status_lookup_table, signal_message_log(i).MESSAGE_STATUS_ID_FK),
                        msh_role_lookup_table(signal_message_log(i).MSH_ROLE_ID_FK),
    ...
    PROCEDURE migrate_user_message_raw(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_signal_message_raw(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_message_properties(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, migrate_message_properties T_LOCAL_TO_REMOTE_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        ...
        LOOP
            ...
            FOR i IN message_properties.FIRST .. message_properties.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_MESSAGE_PROPERTIES@' || db_link || ' (USER_MESSAGE_ID_FK, MESSAGE_PROPERTY_FK, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4)'
                        ...
                        message_properties(i).MESSAGE_PROPERTY_FK,
    ...
    PROCEDURE migrate_message_acknw(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_message_acknw_prop(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_messaging_lock(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        ...
        LOOP
            ...
            FOR i IN messaging_lock.FIRST .. messaging_lock.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_MESSAGING_LOCK@' || db_link || ' (ID_PK, MESSAGE_TYPE, MESSAGE_RECEIVED, MESSAGE_STATE, MESSAGE_ID, INITIATOR, MPC, SEND_ATTEMPTS, SEND_ATTEMPTS_MAX, NEXT_ATTEMPT, FK_TIMEZONE_OFFSET, MESSAGE_STALED, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4, :p_5, :p_6, :p_7, :p_8, :p_9, :p_10, :p_11, :p_12, :p_13, :p_14)'
                        ...
                        messaging_lock(i).FK_TIMEZONE_OFFSET,
    ...
    PROCEDURE migrate_receipt(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        CURSOR c_receipt IS
            SELECT ID_PK, RAW_XML, COMPRESSED, CREATION_TIME, CREATED_BY
            FROM TB_RECEIPT
            WHERE ID_PK IN (
    ...
    PROCEDURE migrate_send_attempt(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    PROCEDURE migrate_error_log(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, msh_role_lookup_table T_LOCAL_TO_REMOTE_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        ...
        LOOP
            ...
            FOR i IN error_log.FIRST .. error_log.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_ERROR_LOG@' || db_link || ' (ID_PK, ERROR_CODE, ERROR_DETAIL, ERROR_SIGNAL_MESSAGE_ID, MESSAGE_IN_ERROR_ID, MSH_ROLE_ID_FK, NOTIFIED, TIME_STAMP, USER_MESSAGE_ID_FK, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4, :p_5, :p_6, :p_7, :p_8, :p_9, :p_10, :p_11)'
                        ...
                        lookup_value_safely(msh_role_lookup_table, error_log(i).MSH_ROLE_ID_FK),
    ...
    PROCEDURE migrate_part_info(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    BEGIN
        ...
        LOOP
            ...
            FOR i IN part_info.FIRST .. part_info.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_PART_INFO@' || db_link || ' (ID_PK, DESCRIPTION_LANG, DESCRIPTION_VALUE, HREF, IN_BODY, FILENAME, MIME, USER_MESSAGE_ID_FK, PART_ORDER, ENCRYPTED, COMPRESSED, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4, :p_5, :p_6, :p_7, :p_8, :p_9, :p_10, :p_11, :p_12, :p_13, :p_14, :p_15)'
    ...
    PROCEDURE migrate_part_properties(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
        ...
        LOOP
            ...
            FOR i IN part_properties.FIRST .. part_properties.LAST LOOP
                    EXECUTE IMMEDIATE 'INSERT INTO TB_PART_PROPERTIES@' || db_link || ' (PART_INFO_ID_FK, PART_INFO_PROPERTY_FK, CREATION_TIME, CREATED_BY) VALUES (:p_1, :p_2, :p_3, :p_4)'
                        ...
                        part_properties(i).PART_INFO_PROPERTY_FK,
    ...
    PROCEDURE migrate_action_audit(ongoing_message_status_pks T_MESSAGE_STATUS_PRIMARY_KEYS, db_link IN VARCHAR2, migration IN T_MIGRATION_DETAILS) IS
    ...
    BEGIN
        ...
        party_lookup_table := migrate_tb_d_party(db_link);
        mpc_lookup_table := migrate_tb_d_mpc(db_link);
        role_lookup_table := migrate_tb_d_role(db_link);
        service_lookup_table := migrate_tb_d_service(db_link);
        agreement_lookup_table := migrate_tb_d_agreement(db_link);
        action_lookup_table := migrate_tb_d_action(db_link);
        msh_role_lookup_table := migrate_tb_d_msh_role(db_link);
        timezone_offset_lookup_table := migrate_tb_d_timezone_offset(db_link);
        notification_status_lookup_table := migrate_tb_d_notification_status(db_link);
        message_property_lookup_table := migrate_tb_d_message_property(db_link);

        migrate_user_message(ongoing_message_status_pks, action_lookup_table, agreement_lookup_table, service_lookup_table, mpc_lookup_table, party_lookup_table, role_lookup_table, db_link, migration);
        migrate_signal_message(ongoing_message_status_pks, db_link, migration);
        migrate_user_message_log(ongoing_message_status_pks, timezone_offset_lookup_table, message_status_lookup_table, msh_role_lookup_table, notification_status_lookup_table, db_link, migration);
        migrate_signal_message_log(ongoing_message_status_pks, message_status_lookup_table, msh_role_lookup_table, db_link, migration);
        migrate_user_message_raw(ongoing_message_status_pks, db_link, migration);
        migrate_signal_message_raw(ongoing_message_status_pks, db_link, migration);

        migrate_message_properties(ongoing_message_status_pks, message_property_lookup_table, db_link, migration);

        migrate_message_acknw(ongoing_message_status_pks, db_link, migration);
        migrate_message_acknw_prop(ongoing_message_status_pks, db_link, migration);
        migrate_messaging_lock(ongoing_message_status_pks, db_link, migration);
        migrate_receipt(ongoing_message_status_pks, db_link, migration);
        migrate_send_attempt(ongoing_message_status_pks, db_link, migration);
        migrate_error_log(ongoing_message_status_pks, msh_role_lookup_table, db_link, migration);

        migrate_part_info(ongoing_message_status_pks, db_link, migration);
        migrate_part_properties(ongoing_message_status_pks, db_link, migration);

        migrate_action_audit(ongoing_message_status_pks, db_link, migration);
